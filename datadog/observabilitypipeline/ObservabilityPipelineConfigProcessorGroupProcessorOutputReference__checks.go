...
func (o *jsiiProxy_ObservabilityPipelineConfigProcessorGroupProcessorOutputReference) validatePutGenerateMetricsParameters(value interface{}) error {
	...
	case *[]*ObservabilityPipelineConfigProcessorGroupProcessorGenerateMetrics:
		value := value.(*[]*ObservabilityPipelineConfigProcessorGroupProcessorGenerateMetrics)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ObservabilityPipelineConfigProcessorGroupProcessorGenerateMetrics:
		value_ := value.([]*ObservabilityPipelineConfigProcessorGroupProcessorGenerateMetrics)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ObservabilityPipelineConfigProcessorGroupProcessorGenerateMetrics; received %#v (a %T)", value, value)
		}
	}
