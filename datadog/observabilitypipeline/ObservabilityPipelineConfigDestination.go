...
type ObservabilityPipelineConfigDestination struct {
	...
	AmazonS3Generic interface{} `field:"optional" json:"amazonS3Generic" yaml:"amazonS3Generic"`
	...
	Clickhouse interface{} `field:"optional" json:"clickhouse" yaml:"clickhouse"`
	// cloud_prem block.
	//
	...
	DatabricksZerobus interface{} `field:"optional" json:"databricksZerobus" yaml:"databricksZerobus"`
	// datadog_logs block.
	//
	...
	SplunkHecMetrics interface{} `field:"optional" json:"splunkHecMetrics" yaml:"splunkHecMetrics"`
	// sumo_logic block.
	//
