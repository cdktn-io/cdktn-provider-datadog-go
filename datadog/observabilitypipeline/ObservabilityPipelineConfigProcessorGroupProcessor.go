...
type ObservabilityPipelineConfigProcessorGroupProcessor struct {
	...
	AddMetricTags interface{} `field:"optional" json:"addMetricTags" yaml:"addMetricTags"`
	// aggregate block.
	//
	...
	Aggregate interface{} `field:"optional" json:"aggregate" yaml:"aggregate"`
	...
	GenerateMetrics interface{} `field:"optional" json:"generateMetrics" yaml:"generateMetrics"`
	// metric_tags block.
	//
	...
	RenameMetricTags interface{} `field:"optional" json:"renameMetricTags" yaml:"renameMetricTags"`
	// sample block.
	//
	...
	TagCardinalityLimit interface{} `field:"optional" json:"tagCardinalityLimit" yaml:"tagCardinalityLimit"`
	// throttle block.
	//
