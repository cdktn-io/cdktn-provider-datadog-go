...
func (d *jsiiProxy_DataDatadogSyntheticsTest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
