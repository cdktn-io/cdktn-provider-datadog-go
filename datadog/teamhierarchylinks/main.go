...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TeamHierarchyLinks)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "subTeamId", GoGetter: "SubTeamId"},
			_jsii_.MemberProperty{JsiiProperty: "subTeamIdInput", GoGetter: "SubTeamIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.teamHierarchyLinks.TeamHierarchyLinksConfig",
		reflect.TypeOf((*TeamHierarchyLinksConfig)(nil)).Elem(),
	)
}
