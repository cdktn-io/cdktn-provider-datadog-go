...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OnCallUserNotificationRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "delayMinutes", GoGetter: "DelayMinutes"},
			_jsii_.MemberProperty{JsiiProperty: "delayMinutesInput", GoGetter: "DelayMinutesInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OnCallUserNotificationRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.onCallUserNotificationRule.OnCallUserNotificationRulePhone",
		reflect.TypeOf((*OnCallUserNotificationRulePhone)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.onCallUserNotificationRule.OnCallUserNotificationRulePhoneOutputReference",
		reflect.TypeOf((*OnCallUserNotificationRulePhoneOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
