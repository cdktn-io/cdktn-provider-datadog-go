...
func (c *jsiiProxy_CustomAllocationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomAllocationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomAllocationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
