...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/team/internal"
...
func (t *jsiiProxy_Team) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_Team) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
