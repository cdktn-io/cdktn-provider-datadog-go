...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/datadatadogteamhierarchylinks/internal"
...
func (d *jsiiProxy_DataDatadogTeamHierarchyLinks) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
