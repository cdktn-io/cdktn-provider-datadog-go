...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogTeamHierarchyLinks)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "filterParentTeam", GoGetter: "FilterParentTeam"},
			_jsii_.MemberProperty{JsiiProperty: "filterParentTeamInput", GoGetter: "FilterParentTeamInput"},
			_jsii_.MemberProperty{JsiiProperty: "filterSubTeam", GoGetter: "FilterSubTeam"},
			_jsii_.MemberProperty{JsiiProperty: "filterSubTeamInput", GoGetter: "FilterSubTeamInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogTeamHierarchyLinks.DataDatadogTeamHierarchyLinksConfig",
		reflect.TypeOf((*DataDatadogTeamHierarchyLinksConfig)(nil)).Elem(),
	)
}
