...
func (j *jsiiProxy_DataDatadogSoftwareCatalog) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDatadogSoftwareCatalog)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDatadogSoftwareCatalog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatadogSoftwareCatalog) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogSoftwareCatalog) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogSoftwareCatalog) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
