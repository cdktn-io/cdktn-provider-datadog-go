...
func (j *jsiiProxy_DataDatadogSoftwareCatalogEntitiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogSoftwareCatalogEntitiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogSoftwareCatalogEntitiesList {
	_init_.Initialize()
...
func NewDataDatadogSoftwareCatalogEntitiesList_Override(d DataDatadogSoftwareCatalogEntitiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogSoftwareCatalogEntitiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogSoftwareCatalogEntitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSoftwareCatalogEntitiesList) Resolve(context cdktn.IResolveContext) interface{} {
