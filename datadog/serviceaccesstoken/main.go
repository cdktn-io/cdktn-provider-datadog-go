...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServiceAccessToken)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicPortion", GoGetter: "PublicPortion"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.serviceAccessToken.ServiceAccessTokenConfig",
		reflect.TypeOf((*ServiceAccessTokenConfig)(nil)).Elem(),
	)
}
