...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v14/integrationawslambdaarn/internal"
...
func (i *jsiiProxy_IntegrationAwsLambdaArn) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
