...
func (l *jsiiProxy_LogsCustomPipeline) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validatePutFilterParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LogsCustomPipelineFilter; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validatePutProcessorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LogsCustomPipelineProcessor; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_LogsCustomPipeline) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
