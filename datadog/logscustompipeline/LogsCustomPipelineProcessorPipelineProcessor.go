...
type LogsCustomPipelineProcessorPipelineProcessor struct {
	...
	ArrayMapProcessor *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor `field:"optional" json:"arrayMapProcessor" yaml:"arrayMapProcessor"`
	...
	ExcludeAttributeProcessor *LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessor `field:"optional" json:"excludeAttributeProcessor" yaml:"excludeAttributeProcessor"`
	// geo_ip_parser block.
	//
