...
type LogsCustomPipelineProcessor struct {
	...
	ArrayMapProcessor *LogsCustomPipelineProcessorArrayMapProcessor `field:"optional" json:"arrayMapProcessor" yaml:"arrayMapProcessor"`
	...
	ExcludeAttributeProcessor *LogsCustomPipelineProcessorExcludeAttributeProcessor `field:"optional" json:"excludeAttributeProcessor" yaml:"excludeAttributeProcessor"`
	// geo_ip_parser block.
	//
