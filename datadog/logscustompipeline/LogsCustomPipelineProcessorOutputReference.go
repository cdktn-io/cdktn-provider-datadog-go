...
type LogsCustomPipelineProcessorOutputReference interface {
	...
	ArrayMapProcessor() LogsCustomPipelineProcessorArrayMapProcessorOutputReference
	ArrayMapProcessorInput() *LogsCustomPipelineProcessorArrayMapProcessor
	...
	PutArrayMapProcessor(value *LogsCustomPipelineProcessorArrayMapProcessor)
...
func (j *jsiiProxy_LogsCustomPipelineProcessorOutputReference) ArrayMapProcessor() LogsCustomPipelineProcessorArrayMapProcessorOutputReference {
	var returns LogsCustomPipelineProcessorArrayMapProcessorOutputReference
	_jsii_.Get(
		j,
		"arrayMapProcessor",
		&returns,
...
func (j *jsiiProxy_LogsCustomPipelineProcessorOutputReference) ArrayMapProcessorInput() *LogsCustomPipelineProcessorArrayMapProcessor {
...
func (j *jsiiProxy_LogsCustomPipelineProcessorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogsCustomPipelineProcessorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LogsCustomPipelineProcessorOutputReference {
	_init_.Initialize()
...
func NewLogsCustomPipelineProcessorOutputReference_Override(l LogsCustomPipelineProcessorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogsCustomPipelineProcessorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) PutArrayMapProcessor(value *LogsCustomPipelineProcessorArrayMapProcessor) {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) ResetArrayMapProcessor() {
	_jsii_.InvokeVoid(
		l,
		"resetArrayMapProcessor",
		nil, // no parameters
...
func (l *jsiiProxy_LogsCustomPipelineProcessorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
