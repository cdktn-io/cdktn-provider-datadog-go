...
type LogsCustomPipelineProcessorPipelineProcessorOutputReference interface {
	...
	ArrayMapProcessor() LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessorOutputReference
	ArrayMapProcessorInput() *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor
	...
	ExcludeAttributeProcessor() LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessorOutputReference
	ExcludeAttributeProcessorInput() *LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessor
	// Experimental.
	Fqn() *string
	...
	PutArrayMapProcessor(value *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor)
	...
	PutExcludeAttributeProcessor(value *LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessor)
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ArrayMapProcessor() LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessorOutputReference {
	var returns LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessorOutputReference
	_jsii_.Get(
		j,
		"arrayMapProcessor",
		&returns,
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ArrayMapProcessorInput() *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor {
	var returns *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor
	_jsii_.Get(
		j,
		"arrayMapProcessorInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ExcludeAttributeProcessor() LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessorOutputReference {
	var returns LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessorOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ExcludeAttributeProcessorInput() *LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessor {
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogsCustomPipelineProcessorPipelineProcessorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LogsCustomPipelineProcessorPipelineProcessorOutputReference {
	_init_.Initialize()
...
func NewLogsCustomPipelineProcessorPipelineProcessorOutputReference_Override(l LogsCustomPipelineProcessorPipelineProcessorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) PutArrayMapProcessor(value *LogsCustomPipelineProcessorPipelineProcessorArrayMapProcessor) {
	if err := l.validatePutArrayMapProcessorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
		"putArrayMapProcessor",
		[]interface{}{value},
	)
}
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) PutExcludeAttributeProcessor(value *LogsCustomPipelineProcessorPipelineProcessorExcludeAttributeProcessor) {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ResetArrayMapProcessor() {
	_jsii_.InvokeVoid(
		l,
		"resetArrayMapProcessor",
		nil, // no parameters
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) ResetExcludeAttributeProcessor() {
	_jsii_.InvokeVoid(
		l,
		"resetExcludeAttributeProcessor",
		nil, // no parameters
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
