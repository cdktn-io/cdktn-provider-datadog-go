...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TagIndexingRuleExemption)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.tagIndexingRuleExemption.TagIndexingRuleExemptionConfig",
		reflect.TypeOf((*TagIndexingRuleExemptionConfig)(nil)).Elem(),
	)
}
