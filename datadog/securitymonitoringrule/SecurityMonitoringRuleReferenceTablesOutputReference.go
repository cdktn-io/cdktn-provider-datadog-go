...
func (j *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityMonitoringRuleReferenceTablesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecurityMonitoringRuleReferenceTablesOutputReference {
	_init_.Initialize()
...
func NewSecurityMonitoringRuleReferenceTablesOutputReference_Override(s SecurityMonitoringRuleReferenceTablesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
