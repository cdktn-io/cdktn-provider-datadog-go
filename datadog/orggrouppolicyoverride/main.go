...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrgGroupPolicyOverride)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "orgSiteInput", GoGetter: "OrgSiteInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrgGroupPolicyOverrideConfig)(nil)).Elem(),
	)
}
