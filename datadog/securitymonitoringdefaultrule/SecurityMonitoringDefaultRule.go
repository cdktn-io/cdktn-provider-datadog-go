...
func (j *jsiiProxy_SecurityMonitoringDefaultRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityMonitoringDefaultRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
