...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/datadatadogservicelevelobjectives/internal"
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDatadogServiceLevelObjectives_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
