...
func (t *jsiiProxy_TeamConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TeamConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
