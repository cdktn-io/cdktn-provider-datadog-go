...
func (s *jsiiProxy_SyntheticsPrivateLocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SyntheticsPrivateLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SyntheticsPrivateLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
