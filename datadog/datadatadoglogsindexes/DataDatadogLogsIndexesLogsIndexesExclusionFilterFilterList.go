...
func (j *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList {
	_init_.Initialize()
...
func NewDataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList_Override(d DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList) Resolve(context cdktn.IResolveContext) interface{} {
