...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AgentlessScanningAzureScanOptions)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetComplianceHost", GoMethod: "ResetComplianceHost"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.agentlessScanningAzureScanOptions.AgentlessScanningAzureScanOptionsConfig",
		reflect.TypeOf((*AgentlessScanningAzureScanOptionsConfig)(nil)).Elem(),
	)
}
