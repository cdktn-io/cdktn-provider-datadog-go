...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.dataDatadogIncidentType.DataDatadogIncidentTypeConfiguration",
		reflect.TypeOf((*DataDatadogIncidentTypeConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.dataDatadogIncidentType.DataDatadogIncidentTypeConfigurationOutputReference",
		reflect.TypeOf((*DataDatadogIncidentTypeConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
