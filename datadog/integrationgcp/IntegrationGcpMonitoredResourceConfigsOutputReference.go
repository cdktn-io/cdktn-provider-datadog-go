...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v14/integrationgcp/internal"
...
func (j *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIntegrationGcpMonitoredResourceConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IntegrationGcpMonitoredResourceConfigsOutputReference {
	_init_.Initialize()
...
func NewIntegrationGcpMonitoredResourceConfigsOutputReference_Override(i IntegrationGcpMonitoredResourceConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
