...
func (i *jsiiProxy_IntegrationGcp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationGcp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IntegrationGcp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
