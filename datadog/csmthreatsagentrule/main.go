...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSilent", GoMethod: "ResetSilent"},
			_jsii_.MemberProperty{JsiiProperty: "silent", GoGetter: "Silent"},
			_jsii_.MemberProperty{JsiiProperty: "silentInput", GoGetter: "SilentInput"},
