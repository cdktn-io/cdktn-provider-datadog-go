...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TeamNotificationRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putMsTeams", GoMethod: "PutMsTeams"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*TeamNotificationRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRuleEmail",
		reflect.TypeOf((*TeamNotificationRuleEmail)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRuleEmailOutputReference",
		reflect.TypeOf((*TeamNotificationRuleEmailOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*TeamNotificationRuleMsTeams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRuleMsTeamsOutputReference",
		reflect.TypeOf((*TeamNotificationRuleMsTeamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetConnectorName", GoMethod: "ResetConnectorName"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*TeamNotificationRulePagerduty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRulePagerdutyOutputReference",
		reflect.TypeOf((*TeamNotificationRulePagerdutyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*TeamNotificationRuleSlack)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRuleSlackOutputReference",
		reflect.TypeOf((*TeamNotificationRuleSlackOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
