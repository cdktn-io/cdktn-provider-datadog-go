...
func (j *jsiiProxy_DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList_Override(d DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetGeomapDefinitionRequestQueryEventQueryComputeList) Resolve(context cdktn.IResolveContext) interface{} {
