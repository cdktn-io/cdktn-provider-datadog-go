...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionCustomLinkList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetTimeseriesDefinitionCustomLinkList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetTimeseriesDefinitionCustomLinkList {
	_init_.Initialize()
...
func NewDashboardWidgetTimeseriesDefinitionCustomLinkList_Override(d DashboardWidgetTimeseriesDefinitionCustomLinkList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionCustomLinkList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionCustomLinkList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionCustomLinkList) Resolve(context cdktn.IResolveContext) interface{} {
