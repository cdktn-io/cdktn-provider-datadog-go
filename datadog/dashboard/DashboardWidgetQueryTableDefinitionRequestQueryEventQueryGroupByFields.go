...
type DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
