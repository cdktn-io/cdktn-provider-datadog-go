...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionOutputReference)SetDescription(val *string) {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
