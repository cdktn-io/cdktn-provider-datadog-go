...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList {
	_init_.Initialize()
...
func NewDashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList_Override(d DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestQueryList) Resolve(context cdktn.IResolveContext) interface{} {
