...
type DashboardWidgetSunburstDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardWidgetSunburstDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
