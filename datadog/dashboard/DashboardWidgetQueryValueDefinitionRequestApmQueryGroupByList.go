...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList {
	_init_.Initialize()
...
func NewDashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList_Override(d DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestApmQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
