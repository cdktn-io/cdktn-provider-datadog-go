...
func (j *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList_Override(d DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestRumQueryMultiComputeList) Resolve(context cdktn.IResolveContext) interface{} {
