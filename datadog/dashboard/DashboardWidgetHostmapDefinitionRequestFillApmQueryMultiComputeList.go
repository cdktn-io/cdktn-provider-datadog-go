...
func (j *jsiiProxy_DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList_Override(d DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetHostmapDefinitionRequestFillApmQueryMultiComputeList) Resolve(context cdktn.IResolveContext) interface{} {
