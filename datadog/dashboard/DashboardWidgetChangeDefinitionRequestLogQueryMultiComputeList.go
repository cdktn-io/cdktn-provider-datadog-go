...
func (j *jsiiProxy_DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList_Override(d DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetChangeDefinitionRequestLogQueryMultiComputeList) Resolve(context cdktn.IResolveContext) interface{} {
