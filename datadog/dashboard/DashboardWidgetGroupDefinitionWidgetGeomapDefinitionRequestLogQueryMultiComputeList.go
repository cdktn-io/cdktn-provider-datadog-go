...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList_Override(d DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList) Resolve(context cdktn.IResolveContext) interface{} {
