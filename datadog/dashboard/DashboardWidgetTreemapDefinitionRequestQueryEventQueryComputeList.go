...
func (j *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList_Override(d DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryEventQueryComputeList) Resolve(context cdktn.IResolveContext) interface{} {
