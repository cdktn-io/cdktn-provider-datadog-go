...
func (j *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList {
	_init_.Initialize()
...
func NewDashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList_Override(d DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
