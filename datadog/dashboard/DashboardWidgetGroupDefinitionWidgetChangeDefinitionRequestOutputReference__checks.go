...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReference) validatePutFormulaParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestFormula; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReference) validatePutQueryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestQuery; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequest; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDashboardWidgetGroupDefinitionWidgetChangeDefinitionRequestOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
