...
func (j *jsiiProxy_DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetDistributionDefinitionRequestRumQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList {
	_init_.Initialize()
...
func NewDashboardWidgetDistributionDefinitionRequestRumQueryGroupByList_Override(d DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetDistributionDefinitionRequestRumQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
