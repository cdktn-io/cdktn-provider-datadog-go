...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList {
	_init_.Initialize()
...
func NewDashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList_Override(d DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList) Resolve(context cdktn.IResolveContext) interface{} {
