...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList {
	_init_.Initialize()
...
func NewDashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList_Override(d DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
