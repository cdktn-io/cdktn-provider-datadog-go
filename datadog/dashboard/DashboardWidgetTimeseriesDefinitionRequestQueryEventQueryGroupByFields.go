...
type DashboardWidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardWidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
