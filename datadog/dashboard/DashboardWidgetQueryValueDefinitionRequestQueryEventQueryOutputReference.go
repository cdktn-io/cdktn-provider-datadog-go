...
type DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference interface {
	...
	GroupByFields() DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFieldsOutputReference
	GroupByFieldsInput() *DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFields
	...
	PutGroupByFields(value *DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFields)
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) GroupByFields() DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFieldsOutputReference {
	var returns DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFieldsOutputReference
	_jsii_.Get(
		j,
		"groupByFields",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) GroupByFieldsInput() *DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFields {
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference {
	_init_.Initialize()
...
func NewDashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference_Override(d DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) PutGroupByFields(value *DashboardWidgetQueryValueDefinitionRequestQueryEventQueryGroupByFields) {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) ResetGroupByFields() {
	_jsii_.InvokeVoid(
		d,
		"resetGroupByFields",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
