...
func (j *jsiiProxy_DashboardWidgetNoteDefinitionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DashboardWidgetNoteDefinitionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DashboardWidgetNoteDefinitionOutputReference)SetDescription(val *string) {
...
func (d *jsiiProxy_DashboardWidgetNoteDefinitionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
