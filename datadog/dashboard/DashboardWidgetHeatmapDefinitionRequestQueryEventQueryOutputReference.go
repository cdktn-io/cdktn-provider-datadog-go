...
type DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference interface {
	...
	GroupByFields() DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFieldsOutputReference
	GroupByFieldsInput() *DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields
	...
	PutGroupByFields(value *DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields)
...
func (j *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) GroupByFields() DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFieldsOutputReference {
	var returns DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFieldsOutputReference
	_jsii_.Get(
		j,
		"groupByFields",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) GroupByFieldsInput() *DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields {
...
func (j *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference {
	_init_.Initialize()
...
func NewDashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference_Override(d DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) PutGroupByFields(value *DashboardWidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields) {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) ResetGroupByFields() {
	_jsii_.InvokeVoid(
		d,
		"resetGroupByFields",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestQueryEventQueryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
