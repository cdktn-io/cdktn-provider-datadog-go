...
func (j *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewChildOrganizationSettingsSamlAutocreateUsersDomainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ChildOrganizationSettingsSamlAutocreateUsersDomainsList {
	_init_.Initialize()
...
func NewChildOrganizationSettingsSamlAutocreateUsersDomainsList_Override(c ChildOrganizationSettingsSamlAutocreateUsersDomainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList) Resolve(context cdktn.IResolveContext) interface{} {
