...
type MonitorVariablesAggregateFilteredQueryBaseEventQuery struct {
	// compute block.
	//
	...
	Search *MonitorVariablesAggregateFilteredQueryBaseEventQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
