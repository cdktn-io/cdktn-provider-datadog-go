...
type MonitorVariablesAggregateAugmentedQueryBaseEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *MonitorVariablesAggregateAugmentedQueryBaseEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
