...
type MonitorVariablesAggregateAugmentedQueryAugmentEventQuery struct {
	// compute block.
	//
	...
	Search *MonitorVariablesAggregateAugmentedQueryAugmentEventQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
