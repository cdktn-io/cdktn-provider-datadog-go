...
type MonitorVariablesAggregateFilteredQueryFilterEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *MonitorVariablesAggregateFilteredQueryFilterEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
