...
type MonitorVariablesAggregateFilteredQueryFilterEventQuery struct {
	// compute block.
	//
	...
	Search *MonitorVariablesAggregateFilteredQueryFilterEventQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
