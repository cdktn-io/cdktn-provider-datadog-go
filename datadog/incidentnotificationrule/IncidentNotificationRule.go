...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/incidentnotificationrule/internal"
...
func (j *jsiiProxy_IncidentNotificationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IncidentNotificationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IncidentNotificationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IncidentNotificationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IncidentNotificationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IncidentNotificationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IncidentNotificationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IncidentNotificationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IncidentNotificationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IncidentNotificationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IncidentNotificationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IncidentNotificationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IncidentNotificationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IncidentNotificationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
