...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogTeamNotificationRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogTeamNotificationRuleMsTeams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.dataDatadogTeamNotificationRule.DataDatadogTeamNotificationRuleMsTeamsOutputReference",
		reflect.TypeOf((*DataDatadogTeamNotificationRuleMsTeamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogTeamNotificationRulePagerduty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.dataDatadogTeamNotificationRule.DataDatadogTeamNotificationRulePagerdutyOutputReference",
		reflect.TypeOf((*DataDatadogTeamNotificationRulePagerdutyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogTeamNotificationRuleSlack)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.dataDatadogTeamNotificationRule.DataDatadogTeamNotificationRuleSlackOutputReference",
		reflect.TypeOf((*DataDatadogTeamNotificationRuleSlackOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
