...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogDatastoreItem)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "itemKey", GoGetter: "ItemKey"},
			_jsii_.MemberProperty{JsiiProperty: "itemKeyInput", GoGetter: "ItemKeyInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogDatastoreItemConfig)(nil)).Elem(),
	)
}
