...
type PowerpackV2WidgetHostmapDefinitionRequestFillApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetHostmapDefinitionRequestFillApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
