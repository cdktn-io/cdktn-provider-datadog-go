...
type PowerpackV2WidgetBarChartDefinitionRequestRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetBarChartDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
