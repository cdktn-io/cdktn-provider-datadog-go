...
type PowerpackV2WidgetTimeseriesDefinitionRequestAuditQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetTimeseriesDefinitionRequestAuditQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
