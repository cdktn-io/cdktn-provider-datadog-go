...
type PowerpackV2WidgetSankeyDefinitionRequestRumRequestQuery struct {
	...
	AudienceFilters *PowerpackV2WidgetSankeyDefinitionRequestRumRequestQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// Entries per step.
	//
	...
	JoinKeys *PowerpackV2WidgetSankeyDefinitionRequestRumRequestQueryJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
	// Number of steps.
	//
	...
	Occurrence *PowerpackV2WidgetSankeyDefinitionRequestRumRequestQueryOccurrence `field:"optional" json:"occurrence" yaml:"occurrence"`
	// Source field.
	//
