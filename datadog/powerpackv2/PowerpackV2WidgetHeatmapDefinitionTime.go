...
type PowerpackV2WidgetHeatmapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetHeatmapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetHeatmapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
