...
type PowerpackV2WidgetTimeseriesDefinitionRequestApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetTimeseriesDefinitionRequestApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
