...
type PowerpackV2WidgetBarChartDefinitionRequestQueryRetentionQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetBarChartDefinitionRequestQueryRetentionQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetBarChartDefinitionRequestQueryRetentionQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
