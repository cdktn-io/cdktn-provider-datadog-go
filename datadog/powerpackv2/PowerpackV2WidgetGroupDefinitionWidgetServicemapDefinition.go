...
type PowerpackV2WidgetGroupDefinitionWidgetServicemapDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetServicemapDefinitionTime `field:"optional" json:"time" yaml:"time"`
