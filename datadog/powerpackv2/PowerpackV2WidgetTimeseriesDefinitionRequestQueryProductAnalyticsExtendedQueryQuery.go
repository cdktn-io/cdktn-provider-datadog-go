...
type PowerpackV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQueryQuery struct {
	...
	Search *PowerpackV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQueryQuerySearch `field:"required" json:"search" yaml:"search"`
}
