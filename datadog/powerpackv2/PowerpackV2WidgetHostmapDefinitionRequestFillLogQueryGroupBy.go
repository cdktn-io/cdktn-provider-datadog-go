...
type PowerpackV2WidgetHostmapDefinitionRequestFillLogQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetHostmapDefinitionRequestFillLogQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
