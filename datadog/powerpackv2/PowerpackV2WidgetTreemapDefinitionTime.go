...
type PowerpackV2WidgetTreemapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetTreemapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetTreemapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
