...
type PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
