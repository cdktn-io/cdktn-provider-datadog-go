...
type PowerpackV2WidgetQueryValueDefinitionRequestApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetQueryValueDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
