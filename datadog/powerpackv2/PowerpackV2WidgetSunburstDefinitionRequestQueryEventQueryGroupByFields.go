...
type PowerpackV2WidgetSunburstDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *PowerpackV2WidgetSunburstDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
