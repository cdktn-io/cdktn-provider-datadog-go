...
type PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinition struct {
	// Workflow ID.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTime `field:"optional" json:"time" yaml:"time"`
