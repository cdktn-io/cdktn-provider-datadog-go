...
type PowerpackV2WidgetSunburstDefinition struct {
	// custom_link block.
	//
	...
	LegendInline *PowerpackV2WidgetSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	...
	LegendTable *PowerpackV2WidgetSunburstDefinitionLegendTable `field:"optional" json:"legendTable" yaml:"legendTable"`
	...
	Time *PowerpackV2WidgetSunburstDefinitionTime `field:"optional" json:"time" yaml:"time"`
