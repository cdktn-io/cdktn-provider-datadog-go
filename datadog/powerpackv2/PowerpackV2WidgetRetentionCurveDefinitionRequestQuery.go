...
type PowerpackV2WidgetRetentionCurveDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetRetentionCurveDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *PowerpackV2WidgetRetentionCurveDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
