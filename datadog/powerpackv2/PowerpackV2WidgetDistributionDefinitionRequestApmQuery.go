...
type PowerpackV2WidgetDistributionDefinitionRequestApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetDistributionDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
