...
type PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
