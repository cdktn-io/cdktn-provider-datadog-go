...
type PowerpackV2WidgetQueryValueDefinition struct {
	...
	Time *PowerpackV2WidgetQueryValueDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	TimeseriesBackground *PowerpackV2WidgetQueryValueDefinitionTimeseriesBackground `field:"optional" json:"timeseriesBackground" yaml:"timeseriesBackground"`
