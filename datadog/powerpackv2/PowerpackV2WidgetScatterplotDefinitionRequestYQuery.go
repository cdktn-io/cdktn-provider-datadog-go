...
type PowerpackV2WidgetScatterplotDefinitionRequestYQuery struct {
	...
	ApmMetricsQuery *PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
	...
	ProductAnalyticsExtendedQuery *PowerpackV2WidgetScatterplotDefinitionRequestYQueryProductAnalyticsExtendedQuery `field:"optional" json:"productAnalyticsExtendedQuery" yaml:"productAnalyticsExtendedQuery"`
	...
	RetentionQuery *PowerpackV2WidgetScatterplotDefinitionRequestYQueryRetentionQuery `field:"optional" json:"retentionQuery" yaml:"retentionQuery"`
	// slo_query block.
	//
	...
	UserJourneyQuery *PowerpackV2WidgetScatterplotDefinitionRequestYQueryUserJourneyQuery `field:"optional" json:"userJourneyQuery" yaml:"userJourneyQuery"`
}
