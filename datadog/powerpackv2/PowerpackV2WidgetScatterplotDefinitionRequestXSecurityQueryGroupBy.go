...
type PowerpackV2WidgetScatterplotDefinitionRequestXSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetScatterplotDefinitionRequestXSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
