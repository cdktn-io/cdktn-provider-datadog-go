...
type PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
