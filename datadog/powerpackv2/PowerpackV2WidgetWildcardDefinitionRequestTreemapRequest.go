...
type PowerpackV2WidgetWildcardDefinitionRequestTreemapRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestStyle `field:"optional" json:"style" yaml:"style"`
}
