...
type PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinition struct {
	...
	Request *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
