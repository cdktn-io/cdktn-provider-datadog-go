...
type PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQueryCompute struct {
	...
	Rollup *PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQueryComputeRollup `field:"optional" json:"rollup" yaml:"rollup"`
}
