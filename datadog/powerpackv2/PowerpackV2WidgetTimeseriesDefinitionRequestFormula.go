...
type PowerpackV2WidgetTimeseriesDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetTimeseriesDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetTimeseriesDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
