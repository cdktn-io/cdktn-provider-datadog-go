...
type PowerpackV2WidgetToplistDefinition struct {
	// custom_link block.
	//
	...
	Style *PowerpackV2WidgetToplistDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetToplistDefinitionTime `field:"optional" json:"time" yaml:"time"`
