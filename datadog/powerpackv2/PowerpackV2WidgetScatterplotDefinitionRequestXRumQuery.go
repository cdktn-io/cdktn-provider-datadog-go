...
type PowerpackV2WidgetScatterplotDefinitionRequestXRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetScatterplotDefinitionRequestXRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
