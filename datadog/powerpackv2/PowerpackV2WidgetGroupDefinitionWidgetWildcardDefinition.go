...
type PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinition struct {
	// custom_link block.
	//
	...
	Specification *PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionSpecification `field:"optional" json:"specification" yaml:"specification"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionTime `field:"optional" json:"time" yaml:"time"`
