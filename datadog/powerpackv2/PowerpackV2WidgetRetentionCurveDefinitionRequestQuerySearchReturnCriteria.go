...
type PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchReturnCriteria struct {
	...
	BaseQuery *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchReturnCriteriaBaseQuery `field:"required" json:"baseQuery" yaml:"baseQuery"`
	// time_interval block.
	//
	...
	TimeInterval *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchReturnCriteriaTimeInterval `field:"optional" json:"timeInterval" yaml:"timeInterval"`
}
