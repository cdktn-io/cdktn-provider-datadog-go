...
type PowerpackV2WidgetChangeDefinitionRequestQueryUserJourneyQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetChangeDefinitionRequestQueryUserJourneyQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetChangeDefinitionRequestQueryUserJourneyQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
