...
type PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
