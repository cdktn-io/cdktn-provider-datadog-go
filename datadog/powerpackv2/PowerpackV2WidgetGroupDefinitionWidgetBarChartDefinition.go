...
type PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinition struct {
	// custom_link block.
	//
	...
	Request *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionTime `field:"optional" json:"time" yaml:"time"`
