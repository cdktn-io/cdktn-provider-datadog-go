...
type PowerpackV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearch struct {
	...
	CohortCriteria *PowerpackV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearchCohortCriteria `field:"required" json:"cohortCriteria" yaml:"cohortCriteria"`
	...
	Filters *PowerpackV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	...
	ReturnCriteria *PowerpackV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearchReturnCriteria `field:"optional" json:"returnCriteria" yaml:"returnCriteria"`
}
