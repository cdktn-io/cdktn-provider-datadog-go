...
type PowerpackV2WidgetQueryValueDefinitionRequestQueryProductAnalyticsExtendedQueryGroupBy struct {
	...
	Sort *PowerpackV2WidgetQueryValueDefinitionRequestQueryProductAnalyticsExtendedQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
