...
type PowerpackV2WidgetFunnelDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetFunnelDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetFunnelDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
