...
type PowerpackV2WidgetLogStreamDefinition struct {
	...
	Sort *PowerpackV2WidgetLogStreamDefinitionSort `field:"optional" json:"sort" yaml:"sort"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetLogStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
