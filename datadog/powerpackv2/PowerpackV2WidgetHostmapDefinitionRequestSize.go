...
type PowerpackV2WidgetHostmapDefinitionRequestSize struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
