...
type PowerpackV2WidgetChangeDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *PowerpackV2WidgetChangeDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *PowerpackV2WidgetChangeDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
