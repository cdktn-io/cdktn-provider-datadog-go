...
type PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearch struct {
	...
	CohortCriteria *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchCohortCriteria `field:"required" json:"cohortCriteria" yaml:"cohortCriteria"`
	...
	Filters *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	...
	ReturnCriteria *PowerpackV2WidgetRetentionCurveDefinitionRequestQuerySearchReturnCriteria `field:"optional" json:"returnCriteria" yaml:"returnCriteria"`
}
