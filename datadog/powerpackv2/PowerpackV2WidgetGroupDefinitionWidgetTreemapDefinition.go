...
type PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinition struct {
	// custom_links block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTime `field:"optional" json:"time" yaml:"time"`
