...
type PowerpackV2WidgetScatterplotDefinitionRequestYApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetScatterplotDefinitionRequestYApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
