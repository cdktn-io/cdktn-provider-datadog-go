...
type PowerpackV2WidgetTimeseriesDefinitionRequestEventQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetTimeseriesDefinitionRequestEventQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
