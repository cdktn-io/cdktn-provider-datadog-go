...
type PowerpackV2WidgetSunburstDefinitionRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetSunburstDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// audit_query block.
	//
	...
	AuditQuery *PowerpackV2WidgetSunburstDefinitionRequestAuditQuery `field:"optional" json:"auditQuery" yaml:"auditQuery"`
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetSunburstDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// network_query block.
	//
	...
	NetworkQuery *PowerpackV2WidgetSunburstDefinitionRequestNetworkQuery `field:"optional" json:"networkQuery" yaml:"networkQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetSunburstDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetSunburstDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetSunburstDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetSunburstDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetSunburstDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
