...
type PowerpackV2WidgetQueryTableDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetQueryTableDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
