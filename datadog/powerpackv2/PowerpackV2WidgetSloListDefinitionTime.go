...
type PowerpackV2WidgetSloListDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetSloListDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetSloListDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
