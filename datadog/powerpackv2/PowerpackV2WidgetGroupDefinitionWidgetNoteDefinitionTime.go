...
type PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
