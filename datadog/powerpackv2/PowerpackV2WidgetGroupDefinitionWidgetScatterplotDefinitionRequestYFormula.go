...
type PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
