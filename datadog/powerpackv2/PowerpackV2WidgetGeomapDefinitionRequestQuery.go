...
type PowerpackV2WidgetGeomapDefinitionRequestQuery struct {
	...
	ApmDependencyStatsQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryApmDependencyStatsQuery `field:"optional" json:"apmDependencyStatsQuery" yaml:"apmDependencyStatsQuery"`
	...
	ApmMetricsQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
	...
	ApmResourceStatsQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQuery `field:"optional" json:"apmResourceStatsQuery" yaml:"apmResourceStatsQuery"`
	...
	CloudCostQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryCloudCostQuery `field:"optional" json:"cloudCostQuery" yaml:"cloudCostQuery"`
	// event_query block.
	//
	...
	EventQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryEventQuery `field:"optional" json:"eventQuery" yaml:"eventQuery"`
	// metric_query block.
	//
	...
	MetricQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryMetricQuery `field:"optional" json:"metricQuery" yaml:"metricQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	ProductAnalyticsExtendedQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryProductAnalyticsExtendedQuery `field:"optional" json:"productAnalyticsExtendedQuery" yaml:"productAnalyticsExtendedQuery"`
	...
	RetentionQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryRetentionQuery `field:"optional" json:"retentionQuery" yaml:"retentionQuery"`
	// slo_query block.
	//
	...
	SloQuery *PowerpackV2WidgetGeomapDefinitionRequestQuerySloQuery `field:"optional" json:"sloQuery" yaml:"sloQuery"`
	...
	UserJourneyQuery *PowerpackV2WidgetGeomapDefinitionRequestQueryUserJourneyQuery `field:"optional" json:"userJourneyQuery" yaml:"userJourneyQuery"`
}
