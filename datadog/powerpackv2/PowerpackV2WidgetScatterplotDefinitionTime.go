...
type PowerpackV2WidgetScatterplotDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetScatterplotDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetScatterplotDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
