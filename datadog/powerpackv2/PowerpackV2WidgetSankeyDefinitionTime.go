...
type PowerpackV2WidgetSankeyDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetSankeyDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetSankeyDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
