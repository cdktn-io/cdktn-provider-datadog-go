...
type PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequest struct {
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	ApmStatsQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestApmStatsQuery `field:"optional" json:"apmStatsQuery" yaml:"apmStatsQuery"`
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// text_formats block.
	//
