...
type PowerpackV2WidgetTimeseriesDefinitionRequestNetworkQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetTimeseriesDefinitionRequestNetworkQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
