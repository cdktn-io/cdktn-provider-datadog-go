...
type PowerpackV2WidgetChangeDefinitionRequestRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetChangeDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
