...
type PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Query *PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQueryQuery `field:"required" json:"query" yaml:"query"`
	...
	AudienceFilters *PowerpackV2WidgetChangeDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// group_by block.
	//
