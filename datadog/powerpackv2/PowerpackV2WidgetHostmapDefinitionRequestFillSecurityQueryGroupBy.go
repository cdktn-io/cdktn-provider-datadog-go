...
type PowerpackV2WidgetHostmapDefinitionRequestFillSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetHostmapDefinitionRequestFillSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
