...
type PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
