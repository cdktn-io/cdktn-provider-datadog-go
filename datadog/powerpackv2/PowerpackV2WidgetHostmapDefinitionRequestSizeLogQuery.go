...
type PowerpackV2WidgetHostmapDefinitionRequestSizeLogQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
