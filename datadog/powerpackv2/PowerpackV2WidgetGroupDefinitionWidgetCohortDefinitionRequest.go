...
type PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequest struct {
	// query block.
	//
	...
	Query *PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
