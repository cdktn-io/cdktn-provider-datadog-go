...
type PowerpackV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *PowerpackV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
