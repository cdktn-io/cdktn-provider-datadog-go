...
type PowerpackV2WidgetTopologyMapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetTopologyMapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetTopologyMapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
