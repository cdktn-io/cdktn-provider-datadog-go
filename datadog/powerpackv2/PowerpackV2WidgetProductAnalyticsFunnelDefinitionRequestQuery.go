...
type PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuery struct {
	...
	Search *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQueryCompute `field:"optional" json:"compute" yaml:"compute"`
	// group_by block.
	//
