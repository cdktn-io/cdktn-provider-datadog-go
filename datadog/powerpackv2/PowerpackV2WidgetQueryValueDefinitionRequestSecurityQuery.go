...
type PowerpackV2WidgetQueryValueDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetQueryValueDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
