...
type PowerpackV2WidgetSunburstDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetSunburstDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
