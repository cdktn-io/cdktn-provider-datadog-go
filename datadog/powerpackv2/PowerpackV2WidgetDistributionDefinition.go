...
type PowerpackV2WidgetDistributionDefinition struct {
	...
	Time *PowerpackV2WidgetDistributionDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *PowerpackV2WidgetDistributionDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *PowerpackV2WidgetDistributionDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
