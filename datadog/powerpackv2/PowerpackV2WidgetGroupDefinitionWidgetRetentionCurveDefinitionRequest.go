...
type PowerpackV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequest struct {
	// query block.
	//
	...
	Query *PowerpackV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
