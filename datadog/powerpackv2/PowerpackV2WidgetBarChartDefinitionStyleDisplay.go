...
type PowerpackV2WidgetBarChartDefinitionStyleDisplay struct {
	// flat block.
	//
	...
	Flat *PowerpackV2WidgetBarChartDefinitionStyleDisplayFlat `field:"optional" json:"flat" yaml:"flat"`
	// stacked block.
	//
	...
	Stacked *PowerpackV2WidgetBarChartDefinitionStyleDisplayStacked `field:"optional" json:"stacked" yaml:"stacked"`
}
