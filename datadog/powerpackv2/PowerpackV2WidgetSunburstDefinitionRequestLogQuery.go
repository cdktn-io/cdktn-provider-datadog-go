...
type PowerpackV2WidgetSunburstDefinitionRequestLogQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetSunburstDefinitionRequestLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
