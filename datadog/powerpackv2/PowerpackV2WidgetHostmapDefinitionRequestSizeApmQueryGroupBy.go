...
type PowerpackV2WidgetHostmapDefinitionRequestSizeApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
