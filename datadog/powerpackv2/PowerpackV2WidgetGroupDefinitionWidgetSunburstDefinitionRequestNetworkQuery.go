...
type PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestNetworkQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestNetworkQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
