...
type PowerpackV2WidgetBarChartDefinition struct {
	...
	Request *PowerpackV2WidgetBarChartDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetBarChartDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetBarChartDefinitionTime `field:"optional" json:"time" yaml:"time"`
