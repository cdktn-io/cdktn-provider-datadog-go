...
type PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQuery struct {
	...
	AudienceFilters *PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// Entries per step.
	//
	...
	JoinKeys *PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
	// Number of steps.
	//
	...
	Occurrence *PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryOccurrence `field:"optional" json:"occurrence" yaml:"occurrence"`
	// Source field.
	//
