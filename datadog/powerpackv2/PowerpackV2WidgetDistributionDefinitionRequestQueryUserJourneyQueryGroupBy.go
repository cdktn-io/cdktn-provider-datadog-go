...
type PowerpackV2WidgetDistributionDefinitionRequestQueryUserJourneyQueryGroupBy struct {
	...
	Sort *PowerpackV2WidgetDistributionDefinitionRequestQueryUserJourneyQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
	// target block.
	//
	...
	Target *PowerpackV2WidgetDistributionDefinitionRequestQueryUserJourneyQueryGroupByTarget `field:"optional" json:"target" yaml:"target"`
}
