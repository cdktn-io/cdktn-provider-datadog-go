...
type PowerpackV2WidgetScatterplotDefinitionRequestXFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetScatterplotDefinitionRequestXFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetScatterplotDefinitionRequestXFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetScatterplotDefinitionRequestXFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
