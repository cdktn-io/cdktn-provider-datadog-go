...
type PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime `field:"optional" json:"time" yaml:"time"`
