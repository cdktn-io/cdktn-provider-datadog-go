...
type PowerpackV2WidgetCohortDefinitionRequestQueryGroupBy struct {
	// Facet to group by.
	//
	...
	Sort *PowerpackV2WidgetCohortDefinitionRequestQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
