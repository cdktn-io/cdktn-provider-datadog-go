...
type PowerpackV2WidgetBarChartDefinitionRequestSortOrderBy struct {
	// formula_sort block.
	//
	...
	FormulaSort *PowerpackV2WidgetBarChartDefinitionRequestSortOrderByFormulaSort `field:"optional" json:"formulaSort" yaml:"formulaSort"`
	// group_sort block.
	//
	...
	GroupSort *PowerpackV2WidgetBarChartDefinitionRequestSortOrderByGroupSort `field:"optional" json:"groupSort" yaml:"groupSort"`
}
