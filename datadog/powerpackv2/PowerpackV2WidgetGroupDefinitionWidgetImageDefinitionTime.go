...
type PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
