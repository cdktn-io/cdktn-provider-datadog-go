...
type PowerpackV2WidgetDistributionDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetDistributionDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetDistributionDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
