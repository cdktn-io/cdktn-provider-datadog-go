...
type PowerpackV2WidgetCohortDefinitionRequestQuerySearch struct {
	...
	CohortCriteria *PowerpackV2WidgetCohortDefinitionRequestQuerySearchCohortCriteria `field:"required" json:"cohortCriteria" yaml:"cohortCriteria"`
	...
	Filters *PowerpackV2WidgetCohortDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	...
	ReturnCriteria *PowerpackV2WidgetCohortDefinitionRequestQuerySearchReturnCriteria `field:"optional" json:"returnCriteria" yaml:"returnCriteria"`
}
