...
type PowerpackV2WidgetChangeDefinitionRequestLogQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetChangeDefinitionRequestLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
