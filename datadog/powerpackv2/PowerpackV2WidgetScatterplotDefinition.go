...
type PowerpackV2WidgetScatterplotDefinition struct {
	...
	Request *PowerpackV2WidgetScatterplotDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetScatterplotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *PowerpackV2WidgetScatterplotDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *PowerpackV2WidgetScatterplotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
