...
type PowerpackV2WidgetSunburstDefinitionRequestQueryUserJourneyQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetSunburstDefinitionRequestQueryUserJourneyQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetSunburstDefinitionRequestQueryUserJourneyQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
