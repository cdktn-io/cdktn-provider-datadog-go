...
type PowerpackV2WidgetRunWorkflowDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetRunWorkflowDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetRunWorkflowDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
