...
type PowerpackV2WidgetBarChartDefinitionRequestApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetBarChartDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
