...
type PowerpackV2WidgetTreemapDefinitionRequestQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *PowerpackV2WidgetTreemapDefinitionRequestQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
