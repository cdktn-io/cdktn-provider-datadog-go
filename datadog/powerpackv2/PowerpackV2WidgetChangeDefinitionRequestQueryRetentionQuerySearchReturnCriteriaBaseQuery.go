...
type PowerpackV2WidgetChangeDefinitionRequestQueryRetentionQuerySearchReturnCriteriaBaseQuery struct {
	...
	Search *PowerpackV2WidgetChangeDefinitionRequestQueryRetentionQuerySearchReturnCriteriaBaseQuerySearch `field:"required" json:"search" yaml:"search"`
}
