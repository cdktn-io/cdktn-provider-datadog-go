...
type PowerpackV2WidgetDistributionDefinitionRequestQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *PowerpackV2WidgetDistributionDefinitionRequestQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
