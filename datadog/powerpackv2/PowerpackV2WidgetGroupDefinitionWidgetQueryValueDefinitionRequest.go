...
type PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest struct {
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// audit_query block.
	//
	...
	AuditQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestAuditQuery `field:"optional" json:"auditQuery" yaml:"auditQuery"`
	// comparison block.
	//
	...
	Comparison *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestComparison `field:"optional" json:"comparison" yaml:"comparison"`
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
