...
type PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetSankeyDefinitionTime `field:"optional" json:"time" yaml:"time"`
