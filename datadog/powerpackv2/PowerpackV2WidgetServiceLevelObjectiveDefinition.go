...
type PowerpackV2WidgetServiceLevelObjectiveDefinition struct {
	...
	Time *PowerpackV2WidgetServiceLevelObjectiveDefinitionTime `field:"optional" json:"time" yaml:"time"`
