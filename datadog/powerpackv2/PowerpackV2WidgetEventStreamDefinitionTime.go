...
type PowerpackV2WidgetEventStreamDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetEventStreamDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetEventStreamDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
