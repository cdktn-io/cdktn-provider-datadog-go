...
type PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
