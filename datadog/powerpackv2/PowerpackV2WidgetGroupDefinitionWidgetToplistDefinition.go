...
type PowerpackV2WidgetGroupDefinitionWidgetToplistDefinition struct {
	// custom_link block.
	//
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTime `field:"optional" json:"time" yaml:"time"`
