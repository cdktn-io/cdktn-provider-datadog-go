...
type PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinition struct {
	// custom_link block.
	//
	...
	RightYaxis *PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxis `field:"optional" json:"rightYaxis" yaml:"rightYaxis"`
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Yaxis *PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
