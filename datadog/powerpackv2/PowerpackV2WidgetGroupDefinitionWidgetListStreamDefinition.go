...
type PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition struct {
	// request block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
