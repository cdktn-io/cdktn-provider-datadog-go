...
type PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
