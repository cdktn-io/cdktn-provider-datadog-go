...
type PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	HistogramRequest *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestHistogramRequest `field:"optional" json:"histogramRequest" yaml:"histogramRequest"`
	// log_query block.
	//
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
