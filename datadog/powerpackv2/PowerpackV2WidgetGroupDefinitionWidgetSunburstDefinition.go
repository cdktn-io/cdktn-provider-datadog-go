...
type PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinition struct {
	// custom_link block.
	//
	...
	LegendInline *PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	...
	LegendTable *PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTable `field:"optional" json:"legendTable" yaml:"legendTable"`
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTime `field:"optional" json:"time" yaml:"time"`
