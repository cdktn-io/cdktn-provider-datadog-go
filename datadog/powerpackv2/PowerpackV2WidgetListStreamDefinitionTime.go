...
type PowerpackV2WidgetListStreamDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetListStreamDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetListStreamDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
