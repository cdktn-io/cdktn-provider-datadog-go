...
type PowerpackV2WidgetHostmapDefinitionRequestFillSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHostmapDefinitionRequestFillSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
