...
type PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
