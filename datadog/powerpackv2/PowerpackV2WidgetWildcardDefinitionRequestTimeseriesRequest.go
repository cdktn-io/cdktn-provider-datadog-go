...
type PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	LogQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestStyle `field:"optional" json:"style" yaml:"style"`
}
