...
type PowerpackV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryGroupBy struct {
	...
	Sort *PowerpackV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
