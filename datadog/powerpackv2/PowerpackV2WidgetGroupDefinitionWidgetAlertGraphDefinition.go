...
type PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime `field:"optional" json:"time" yaml:"time"`
