...
type PowerpackV2WidgetGroupDefinitionWidgetCohortDefinition struct {
	// request block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTime `field:"optional" json:"time" yaml:"time"`
