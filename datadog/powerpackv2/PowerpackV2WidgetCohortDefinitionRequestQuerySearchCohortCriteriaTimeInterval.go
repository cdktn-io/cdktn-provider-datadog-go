...
type PowerpackV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaTimeInterval struct {
	...
	Value *PowerpackV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaTimeIntervalValue `field:"required" json:"value" yaml:"value"`
}
