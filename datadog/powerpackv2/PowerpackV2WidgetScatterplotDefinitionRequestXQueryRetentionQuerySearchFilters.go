...
type PowerpackV2WidgetScatterplotDefinitionRequestXQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *PowerpackV2WidgetScatterplotDefinitionRequestXQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
