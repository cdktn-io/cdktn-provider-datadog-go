...
type PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
