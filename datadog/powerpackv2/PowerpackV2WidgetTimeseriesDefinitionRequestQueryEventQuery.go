...
type PowerpackV2WidgetTimeseriesDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *PowerpackV2WidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *PowerpackV2WidgetTimeseriesDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
