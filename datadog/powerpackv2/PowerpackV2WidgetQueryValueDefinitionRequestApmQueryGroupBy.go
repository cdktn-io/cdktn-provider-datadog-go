...
type PowerpackV2WidgetQueryValueDefinitionRequestApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetQueryValueDefinitionRequestApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
