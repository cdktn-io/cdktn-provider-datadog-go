...
type PowerpackV2WidgetDistributionDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetDistributionDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
