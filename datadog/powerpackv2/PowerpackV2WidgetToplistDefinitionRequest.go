...
type PowerpackV2WidgetToplistDefinitionRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetToplistDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// audit_query block.
	//
	...
	AuditQuery *PowerpackV2WidgetToplistDefinitionRequestAuditQuery `field:"optional" json:"auditQuery" yaml:"auditQuery"`
	...
	LogQuery *PowerpackV2WidgetToplistDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetToplistDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetToplistDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetToplistDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *PowerpackV2WidgetToplistDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetToplistDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
