...
type PowerpackV2WidgetHostmapDefinitionRequestFillRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetHostmapDefinitionRequestFillRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
