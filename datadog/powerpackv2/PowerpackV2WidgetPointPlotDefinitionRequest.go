...
type PowerpackV2WidgetPointPlotDefinitionRequest struct {
	// projection block.
	//
	...
	Projection *PowerpackV2WidgetPointPlotDefinitionRequestProjection `field:"required" json:"projection" yaml:"projection"`
	// query block.
	//
	...
	Query *PowerpackV2WidgetPointPlotDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
