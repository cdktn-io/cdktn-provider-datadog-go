...
type PowerpackV2WidgetToplistDefinitionRequestRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetToplistDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
