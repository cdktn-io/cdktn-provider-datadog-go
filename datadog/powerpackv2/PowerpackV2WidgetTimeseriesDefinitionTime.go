...
type PowerpackV2WidgetTimeseriesDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetTimeseriesDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetTimeseriesDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
