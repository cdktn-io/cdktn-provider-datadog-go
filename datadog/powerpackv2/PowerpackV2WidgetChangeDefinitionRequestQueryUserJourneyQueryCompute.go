...
type PowerpackV2WidgetChangeDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *PowerpackV2WidgetChangeDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
