...
type PowerpackV2WidgetChangeDefinitionRequestSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetChangeDefinitionRequestSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
