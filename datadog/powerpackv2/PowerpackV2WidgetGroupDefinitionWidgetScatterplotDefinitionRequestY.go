...
type PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestY struct {
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestYSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
