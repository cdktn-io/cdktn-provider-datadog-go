...
type PowerpackV2WidgetQueryValueDefinitionRequestRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetQueryValueDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
