...
type PowerpackV2WidgetGeomapDefinition struct {
	// custom_link block.
	//
	...
	Style *PowerpackV2WidgetGeomapDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGeomapDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	View *PowerpackV2WidgetGeomapDefinitionView `field:"optional" json:"view" yaml:"view"`
}
