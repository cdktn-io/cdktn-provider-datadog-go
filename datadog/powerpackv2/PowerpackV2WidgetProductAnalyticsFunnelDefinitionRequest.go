...
type PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest struct {
	// query block.
	//
	...
	Query *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
	...
	ComparisonTime *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestComparisonTime `field:"optional" json:"comparisonTime" yaml:"comparisonTime"`
}
