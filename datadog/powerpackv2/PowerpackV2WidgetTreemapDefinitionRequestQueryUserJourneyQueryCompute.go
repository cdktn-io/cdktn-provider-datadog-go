...
type PowerpackV2WidgetTreemapDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *PowerpackV2WidgetTreemapDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
