...
type PowerpackV2WidgetGroupDefinitionWidgetManageStatusDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetManageStatusDefinitionTime `field:"optional" json:"time" yaml:"time"`
