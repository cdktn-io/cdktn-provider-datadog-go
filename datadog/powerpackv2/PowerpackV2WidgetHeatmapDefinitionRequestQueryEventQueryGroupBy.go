...
type PowerpackV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *PowerpackV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
