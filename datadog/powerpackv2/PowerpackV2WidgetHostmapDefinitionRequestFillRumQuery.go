...
type PowerpackV2WidgetHostmapDefinitionRequestFillRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHostmapDefinitionRequestFillRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
