...
type PowerpackV2WidgetHeatmapDefinitionRequestQueryProductAnalyticsExtendedQueryQuery struct {
	...
	Search *PowerpackV2WidgetHeatmapDefinitionRequestQueryProductAnalyticsExtendedQueryQuerySearch `field:"required" json:"search" yaml:"search"`
}
