...
type PowerpackV2WidgetScatterplotDefinitionRequestYQueryUserJourneyQuerySearch struct {
	...
	Filters *PowerpackV2WidgetScatterplotDefinitionRequestYQueryUserJourneyQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	// join_keys block.
	//
	...
	JoinKeys *PowerpackV2WidgetScatterplotDefinitionRequestYQueryUserJourneyQuerySearchJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
