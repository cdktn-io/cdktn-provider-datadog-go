...
type PowerpackV2WidgetPointPlotDefinition struct {
	// custom_link block.
	//
	...
	Legend *PowerpackV2WidgetPointPlotDefinitionLegend `field:"optional" json:"legend" yaml:"legend"`
	...
	Time *PowerpackV2WidgetPointPlotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Yaxis *PowerpackV2WidgetPointPlotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
