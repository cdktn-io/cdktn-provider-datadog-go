...
type PowerpackV2WidgetHostmapDefinitionRequestFillQuery struct {
	...
	ApmMetricsQuery *PowerpackV2WidgetHostmapDefinitionRequestFillQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
	...
	ProductAnalyticsExtendedQuery *PowerpackV2WidgetHostmapDefinitionRequestFillQueryProductAnalyticsExtendedQuery `field:"optional" json:"productAnalyticsExtendedQuery" yaml:"productAnalyticsExtendedQuery"`
	...
	RetentionQuery *PowerpackV2WidgetHostmapDefinitionRequestFillQueryRetentionQuery `field:"optional" json:"retentionQuery" yaml:"retentionQuery"`
	// slo_query block.
	//
	...
	UserJourneyQuery *PowerpackV2WidgetHostmapDefinitionRequestFillQueryUserJourneyQuery `field:"optional" json:"userJourneyQuery" yaml:"userJourneyQuery"`
}
