...
type PowerpackV2WidgetRetentionCurveDefinitionRequestQueryFilters struct {
	...
	AudienceFilters *PowerpackV2WidgetRetentionCurveDefinitionRequestQueryFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
