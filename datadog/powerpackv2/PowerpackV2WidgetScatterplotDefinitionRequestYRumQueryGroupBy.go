...
type PowerpackV2WidgetScatterplotDefinitionRequestYRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetScatterplotDefinitionRequestYRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
