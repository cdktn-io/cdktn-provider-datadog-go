...
type PowerpackV2WidgetHeatmapDefinition struct {
	// custom_link block.
	//
	...
	Time *PowerpackV2WidgetHeatmapDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *PowerpackV2WidgetHeatmapDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *PowerpackV2WidgetHeatmapDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
