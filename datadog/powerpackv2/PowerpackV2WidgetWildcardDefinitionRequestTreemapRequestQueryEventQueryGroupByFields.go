...
type PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryEventQueryGroupByFields struct {
	...
	Sort *PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
