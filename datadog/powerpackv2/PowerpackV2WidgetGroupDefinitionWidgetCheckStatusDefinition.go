...
type PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime `field:"optional" json:"time" yaml:"time"`
