...
type PowerpackV2WidgetCohortDefinitionRequestQueryFilters struct {
	...
	AudienceFilters *PowerpackV2WidgetCohortDefinitionRequestQueryFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
