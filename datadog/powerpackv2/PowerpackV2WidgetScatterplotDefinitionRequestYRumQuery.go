...
type PowerpackV2WidgetScatterplotDefinitionRequestYRumQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetScatterplotDefinitionRequestYRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
