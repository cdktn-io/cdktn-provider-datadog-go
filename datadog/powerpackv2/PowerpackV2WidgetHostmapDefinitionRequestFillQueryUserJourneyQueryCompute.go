...
type PowerpackV2WidgetHostmapDefinitionRequestFillQueryUserJourneyQueryCompute struct {
	...
	Target *PowerpackV2WidgetHostmapDefinitionRequestFillQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
