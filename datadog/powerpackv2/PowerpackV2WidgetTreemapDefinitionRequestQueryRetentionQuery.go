...
type PowerpackV2WidgetTreemapDefinitionRequestQueryRetentionQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetTreemapDefinitionRequestQueryRetentionQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetTreemapDefinitionRequestQueryRetentionQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
