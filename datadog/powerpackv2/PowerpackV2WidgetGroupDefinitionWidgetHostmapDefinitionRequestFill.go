...
type PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFill struct {
	// apm_query block.
	//
	...
	ApmQuery *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
