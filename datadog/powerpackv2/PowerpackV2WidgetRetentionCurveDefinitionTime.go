...
type PowerpackV2WidgetRetentionCurveDefinitionTime struct {
	...
	Fixed *PowerpackV2WidgetRetentionCurveDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetRetentionCurveDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
