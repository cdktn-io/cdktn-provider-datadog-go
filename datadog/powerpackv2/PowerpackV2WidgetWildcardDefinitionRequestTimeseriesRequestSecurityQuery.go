...
type PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
