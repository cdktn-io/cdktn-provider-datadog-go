...
type PowerpackV2WidgetChangeDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetChangeDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetChangeDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
