...
type PowerpackV2WidgetSunburstDefinitionRequestNetworkQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetSunburstDefinitionRequestNetworkQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
