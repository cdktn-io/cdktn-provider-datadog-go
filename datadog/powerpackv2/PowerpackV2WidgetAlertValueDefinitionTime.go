...
type PowerpackV2WidgetAlertValueDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetAlertValueDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetAlertValueDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
