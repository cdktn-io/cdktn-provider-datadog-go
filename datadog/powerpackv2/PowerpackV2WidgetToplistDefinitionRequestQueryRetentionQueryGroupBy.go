...
type PowerpackV2WidgetToplistDefinitionRequestQueryRetentionQueryGroupBy struct {
	// Facet to group by.
	//
	...
	Sort *PowerpackV2WidgetToplistDefinitionRequestQueryRetentionQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
