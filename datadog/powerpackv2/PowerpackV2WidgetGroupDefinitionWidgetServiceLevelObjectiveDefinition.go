...
type PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime `field:"optional" json:"time" yaml:"time"`
