...
type PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestComparison struct {
	// duration block.
	//
	...
	Duration *PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestComparisonDuration `field:"required" json:"duration" yaml:"duration"`
