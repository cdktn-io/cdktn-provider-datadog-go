...
type PowerpackV2WidgetHostmapDefinitionRequestSizeQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *PowerpackV2WidgetHostmapDefinitionRequestSizeQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *PowerpackV2WidgetHostmapDefinitionRequestSizeQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
