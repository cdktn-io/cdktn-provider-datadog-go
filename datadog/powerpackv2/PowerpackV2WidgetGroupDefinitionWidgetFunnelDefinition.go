...
type PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinition struct {
	...
	GroupedDisplay *string `field:"optional" json:"groupedDisplay" yaml:"groupedDisplay"`
	...
	Request *PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
