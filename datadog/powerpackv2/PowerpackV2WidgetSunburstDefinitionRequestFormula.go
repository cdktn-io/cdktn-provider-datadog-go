...
type PowerpackV2WidgetSunburstDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetSunburstDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetSunburstDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetSunburstDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
