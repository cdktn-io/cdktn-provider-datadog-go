...
type PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
