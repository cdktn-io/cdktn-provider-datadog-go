...
type PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearch struct {
	...
	Filters *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	// join_keys block.
	//
	...
	JoinKeys *PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearchJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
