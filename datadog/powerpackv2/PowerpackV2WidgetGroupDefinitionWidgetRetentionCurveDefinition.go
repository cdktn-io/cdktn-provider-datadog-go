...
type PowerpackV2WidgetGroupDefinitionWidgetRetentionCurveDefinition struct {
	// request block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionTime `field:"optional" json:"time" yaml:"time"`
