...
type PowerpackV2WidgetHeatmapDefinitionRequestApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHeatmapDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
