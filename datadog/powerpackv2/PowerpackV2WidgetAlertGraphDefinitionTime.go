...
type PowerpackV2WidgetAlertGraphDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetAlertGraphDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetAlertGraphDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
