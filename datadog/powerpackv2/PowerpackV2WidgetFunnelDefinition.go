...
type PowerpackV2WidgetFunnelDefinition struct {
	...
	Request *PowerpackV2WidgetFunnelDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
