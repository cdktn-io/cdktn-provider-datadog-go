...
type PowerpackV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaBaseQuery struct {
	...
	Search *PowerpackV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaBaseQuerySearch `field:"required" json:"search" yaml:"search"`
}
