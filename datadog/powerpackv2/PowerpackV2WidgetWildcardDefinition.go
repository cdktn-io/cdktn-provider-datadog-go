...
type PowerpackV2WidgetWildcardDefinition struct {
	// custom_link block.
	//
	...
	Specification *PowerpackV2WidgetWildcardDefinitionSpecification `field:"optional" json:"specification" yaml:"specification"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetWildcardDefinitionTime `field:"optional" json:"time" yaml:"time"`
