...
type PowerpackV2WidgetDistributionDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *PowerpackV2WidgetDistributionDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *PowerpackV2WidgetDistributionDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
