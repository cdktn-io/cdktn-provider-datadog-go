...
type PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinition struct {
	// custom_link block.
	//
	...
	Request *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	...
	Style *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionTime `field:"optional" json:"time" yaml:"time"`
