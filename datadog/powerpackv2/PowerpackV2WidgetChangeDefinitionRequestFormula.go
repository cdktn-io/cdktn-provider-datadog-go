...
type PowerpackV2WidgetChangeDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *PowerpackV2WidgetChangeDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *PowerpackV2WidgetChangeDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *PowerpackV2WidgetChangeDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *PowerpackV2WidgetChangeDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
