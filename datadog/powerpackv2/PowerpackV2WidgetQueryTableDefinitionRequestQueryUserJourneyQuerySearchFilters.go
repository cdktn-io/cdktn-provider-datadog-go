...
type PowerpackV2WidgetQueryTableDefinitionRequestQueryUserJourneyQuerySearchFilters struct {
	...
	AudienceFilters *PowerpackV2WidgetQueryTableDefinitionRequestQueryUserJourneyQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// graph_filter block.
	//
