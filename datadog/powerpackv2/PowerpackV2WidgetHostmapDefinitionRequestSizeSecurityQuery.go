...
type PowerpackV2WidgetHostmapDefinitionRequestSizeSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHostmapDefinitionRequestSizeSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
