...
type PowerpackV2WidgetIframeDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *PowerpackV2WidgetIframeDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *PowerpackV2WidgetIframeDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
