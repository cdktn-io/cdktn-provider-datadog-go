...
type PowerpackV2WidgetRetentionCurveDefinitionRequestQueryGroupBy struct {
	// Facet to group by.
	//
	...
	Sort *PowerpackV2WidgetRetentionCurveDefinitionRequestQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
