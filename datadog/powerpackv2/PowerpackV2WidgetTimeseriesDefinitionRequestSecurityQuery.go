...
type PowerpackV2WidgetTimeseriesDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetTimeseriesDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
