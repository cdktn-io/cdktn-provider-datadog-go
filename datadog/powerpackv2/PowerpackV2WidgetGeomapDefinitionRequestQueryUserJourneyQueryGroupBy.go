...
type PowerpackV2WidgetGeomapDefinitionRequestQueryUserJourneyQueryGroupBy struct {
	...
	Sort *PowerpackV2WidgetGeomapDefinitionRequestQueryUserJourneyQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
	// target block.
	//
	...
	Target *PowerpackV2WidgetGeomapDefinitionRequestQueryUserJourneyQueryGroupByTarget `field:"optional" json:"target" yaml:"target"`
}
