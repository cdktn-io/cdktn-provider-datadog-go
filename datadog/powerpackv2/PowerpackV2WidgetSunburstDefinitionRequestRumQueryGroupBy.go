...
type PowerpackV2WidgetSunburstDefinitionRequestRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetSunburstDefinitionRequestRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
