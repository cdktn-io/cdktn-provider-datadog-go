...
type PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestEventQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestEventQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
