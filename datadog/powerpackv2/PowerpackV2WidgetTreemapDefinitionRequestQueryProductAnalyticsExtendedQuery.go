...
type PowerpackV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Query *PowerpackV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryQuery `field:"required" json:"query" yaml:"query"`
	...
	AudienceFilters *PowerpackV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// group_by block.
	//
