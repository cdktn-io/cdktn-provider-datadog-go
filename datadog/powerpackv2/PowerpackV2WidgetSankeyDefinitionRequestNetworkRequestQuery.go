...
type PowerpackV2WidgetSankeyDefinitionRequestNetworkRequestQuery struct {
	...
	Compute *PowerpackV2WidgetSankeyDefinitionRequestNetworkRequestQueryCompute `field:"optional" json:"compute" yaml:"compute"`
	...
	Sort *PowerpackV2WidgetSankeyDefinitionRequestNetworkRequestQuerySort `field:"optional" json:"sort" yaml:"sort"`
}
