...
type PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime `field:"optional" json:"time" yaml:"time"`
