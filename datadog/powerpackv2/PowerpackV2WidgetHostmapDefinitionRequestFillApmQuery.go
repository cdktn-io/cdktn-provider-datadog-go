...
type PowerpackV2WidgetHostmapDefinitionRequestFillApmQuery struct {
	...
	ComputeQuery *PowerpackV2WidgetHostmapDefinitionRequestFillApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
