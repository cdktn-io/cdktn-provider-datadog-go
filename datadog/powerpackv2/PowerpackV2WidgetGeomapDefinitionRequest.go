...
type PowerpackV2WidgetGeomapDefinitionRequest struct {
	// formula block.
	//
	...
	LogQuery *PowerpackV2WidgetGeomapDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	...
	RumQuery *PowerpackV2WidgetGeomapDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
}
