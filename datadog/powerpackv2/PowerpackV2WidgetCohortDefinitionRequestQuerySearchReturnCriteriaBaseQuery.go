...
type PowerpackV2WidgetCohortDefinitionRequestQuerySearchReturnCriteriaBaseQuery struct {
	...
	Search *PowerpackV2WidgetCohortDefinitionRequestQuerySearchReturnCriteriaBaseQuerySearch `field:"required" json:"search" yaml:"search"`
}
