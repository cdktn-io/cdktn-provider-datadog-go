...
type PowerpackV2WidgetProductAnalyticsFunnelDefinition struct {
	// request block.
	//
	...
	Time *PowerpackV2WidgetProductAnalyticsFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
