...
type PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinition struct {
	// request block.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
