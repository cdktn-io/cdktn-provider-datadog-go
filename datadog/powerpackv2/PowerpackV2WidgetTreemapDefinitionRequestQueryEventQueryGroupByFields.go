...
type PowerpackV2WidgetTreemapDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *PowerpackV2WidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
