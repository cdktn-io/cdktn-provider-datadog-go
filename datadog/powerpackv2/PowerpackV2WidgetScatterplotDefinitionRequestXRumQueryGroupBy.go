...
type PowerpackV2WidgetScatterplotDefinitionRequestXRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackV2WidgetScatterplotDefinitionRequestXRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
