...
type PowerpackV2WidgetCohortDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *PowerpackV2WidgetCohortDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *PowerpackV2WidgetCohortDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *PowerpackV2WidgetCohortDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
