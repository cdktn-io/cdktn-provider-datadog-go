...
type PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinition struct {
	// APM environment.
	//
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTime `field:"optional" json:"time" yaml:"time"`
