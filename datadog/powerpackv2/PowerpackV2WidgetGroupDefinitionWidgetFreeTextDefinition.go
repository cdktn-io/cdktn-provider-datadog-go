...
type PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition struct {
	...
	Time *PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime `field:"optional" json:"time" yaml:"time"`
