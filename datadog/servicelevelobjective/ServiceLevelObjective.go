...
func (s *jsiiProxy_ServiceLevelObjective) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceLevelObjective) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceLevelObjective) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
