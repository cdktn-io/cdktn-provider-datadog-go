...
func (i *jsiiProxy_IntegrationAzure) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationAzure) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
