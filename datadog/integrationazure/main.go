...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretlessAuthEnabled", GoMethod: "ResetSecretlessAuthEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "secretlessAuthEnabled", GoGetter: "SecretlessAuthEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "secretlessAuthEnabledInput", GoGetter: "SecretlessAuthEnabledInput"},
