...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/downtimeschedule/internal"
...
func (j *jsiiProxy_DowntimeSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DowntimeSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DowntimeSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DowntimeSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DowntimeSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DowntimeSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DowntimeSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DowntimeSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DowntimeSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DowntimeSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DowntimeSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DowntimeSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DowntimeSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DowntimeSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DowntimeSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
