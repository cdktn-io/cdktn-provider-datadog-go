...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrgGroupPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enforcementTierInput", GoGetter: "EnforcementTierInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnforcementTier", GoMethod: "ResetEnforcementTier"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrgGroupPolicyConfig)(nil)).Elem(),
	)
}
