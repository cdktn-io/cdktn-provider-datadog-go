...
func (s *jsiiProxy_SecureEmbedDashboard) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecureEmbedDashboard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
