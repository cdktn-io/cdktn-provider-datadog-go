...
func (s *jsiiProxy_SyntheticsGlobalVariable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SyntheticsGlobalVariable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
