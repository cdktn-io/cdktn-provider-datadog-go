...
func (s *jsiiProxy_SyntheticsGlobalVariableOptionsOutputReference) validatePutTotpParametersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SyntheticsGlobalVariableOptionsTotpParameters; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SyntheticsGlobalVariableOptionsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SyntheticsGlobalVariableOptionsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *SyntheticsGlobalVariableOptions; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_SyntheticsGlobalVariableOptionsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewSyntheticsGlobalVariableOptionsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
