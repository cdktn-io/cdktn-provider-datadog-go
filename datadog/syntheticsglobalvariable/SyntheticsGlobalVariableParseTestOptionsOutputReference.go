...
func (j *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsGlobalVariableParseTestOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsGlobalVariableParseTestOptionsOutputReference {
	_init_.Initialize()
...
func NewSyntheticsGlobalVariableParseTestOptionsOutputReference_Override(s SyntheticsGlobalVariableParseTestOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
