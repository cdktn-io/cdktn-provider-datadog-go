...
func (l *jsiiProxy_LogsIndex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogsIndex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
