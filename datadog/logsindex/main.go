...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSampleAttribute", GoMethod: "ResetSampleAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetSampleRate", GoMethod: "ResetSampleRate"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sampleAttribute", GoGetter: "SampleAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "sampleAttributeInput", GoGetter: "SampleAttributeInput"},
