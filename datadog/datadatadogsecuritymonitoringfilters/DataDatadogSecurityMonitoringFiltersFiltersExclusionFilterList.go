...
func (j *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList {
	_init_.Initialize()
...
func NewDataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList_Override(d DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList) Resolve(context cdktn.IResolveContext) interface{} {
