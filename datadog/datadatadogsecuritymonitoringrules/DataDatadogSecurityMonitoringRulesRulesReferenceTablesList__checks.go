...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesReferenceTablesList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesReferenceTablesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataDatadogSecurityMonitoringRulesRulesReferenceTablesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
