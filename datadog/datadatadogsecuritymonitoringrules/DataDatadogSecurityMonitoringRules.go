...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDatadogSecurityMonitoringRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRules) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRules) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRules) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
