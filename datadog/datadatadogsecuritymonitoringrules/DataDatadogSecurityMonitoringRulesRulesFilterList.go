...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogSecurityMonitoringRulesRulesFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogSecurityMonitoringRulesRulesFilterList {
	_init_.Initialize()
...
func NewDataDatadogSecurityMonitoringRulesRulesFilterList_Override(d DataDatadogSecurityMonitoringRulesRulesFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesFilterList) Resolve(context cdktn.IResolveContext) interface{} {
