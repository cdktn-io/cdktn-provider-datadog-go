...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesCaseList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogSecurityMonitoringRulesRulesCaseList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogSecurityMonitoringRulesRulesCaseList {
	_init_.Initialize()
...
func NewDataDatadogSecurityMonitoringRulesRulesCaseList_Override(d DataDatadogSecurityMonitoringRulesRulesCaseList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesCaseList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesCaseList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesCaseList) Resolve(context cdktn.IResolveContext) interface{} {
