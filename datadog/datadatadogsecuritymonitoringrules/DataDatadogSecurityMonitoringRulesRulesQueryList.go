...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogSecurityMonitoringRulesRulesQueryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogSecurityMonitoringRulesRulesQueryList {
	_init_.Initialize()
...
func NewDataDatadogSecurityMonitoringRulesRulesQueryList_Override(d DataDatadogSecurityMonitoringRulesRulesQueryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList) Resolve(context cdktn.IResolveContext) interface{} {
