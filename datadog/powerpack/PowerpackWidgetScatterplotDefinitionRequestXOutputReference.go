...
func (j *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetScatterplotDefinitionRequestXOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetScatterplotDefinitionRequestXOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetScatterplotDefinitionRequestXOutputReference_Override(p PowerpackWidgetScatterplotDefinitionRequestXOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionRequestXOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
