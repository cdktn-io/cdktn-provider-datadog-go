...
func (j *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetTreemapDefinitionRequestFormulaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetTreemapDefinitionRequestFormulaOutputReference_Override(p PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestFormulaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
