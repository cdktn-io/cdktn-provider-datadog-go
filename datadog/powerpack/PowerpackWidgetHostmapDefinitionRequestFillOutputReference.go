...
func (j *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetHostmapDefinitionRequestFillOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetHostmapDefinitionRequestFillOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetHostmapDefinitionRequestFillOutputReference_Override(p PowerpackWidgetHostmapDefinitionRequestFillOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestFillOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
