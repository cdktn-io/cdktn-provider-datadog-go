...
func (j *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference_Override(p PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
