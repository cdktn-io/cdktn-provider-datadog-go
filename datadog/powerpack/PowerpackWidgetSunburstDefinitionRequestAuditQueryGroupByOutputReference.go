...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference_Override(p PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestAuditQueryGroupByOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
