...
func (j *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList {
	_init_.Initialize()
...
func NewPowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList_Override(p PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
