...
func (j *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetDistributionDefinitionYaxisOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PowerpackWidgetDistributionDefinitionYaxisOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetDistributionDefinitionYaxisOutputReference_Override(p PowerpackWidgetDistributionDefinitionYaxisOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionYaxisOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
