...
func (j *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetChangeDefinitionRequestOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetChangeDefinitionRequestOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetChangeDefinitionRequestOutputReference_Override(p PowerpackWidgetChangeDefinitionRequestOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetChangeDefinitionRequestOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
