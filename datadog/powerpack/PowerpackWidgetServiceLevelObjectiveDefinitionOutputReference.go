...
func (j *jsiiProxy_PowerpackWidgetServiceLevelObjectiveDefinitionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_PowerpackWidgetServiceLevelObjectiveDefinitionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_PowerpackWidgetServiceLevelObjectiveDefinitionOutputReference)SetDescription(val *string) {
...
func (p *jsiiProxy_PowerpackWidgetServiceLevelObjectiveDefinitionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		p,
		"resetDescription",
		nil, // no parameters
