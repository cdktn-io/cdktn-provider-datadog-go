...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetHeatmapDefinitionRequestQueryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetHeatmapDefinitionRequestQueryOutputReference_Override(p PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestQueryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
