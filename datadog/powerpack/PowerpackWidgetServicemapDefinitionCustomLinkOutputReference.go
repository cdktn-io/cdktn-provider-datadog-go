...
func (j *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetServicemapDefinitionCustomLinkOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetServicemapDefinitionCustomLinkOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetServicemapDefinitionCustomLinkOutputReference_Override(p PowerpackWidgetServicemapDefinitionCustomLinkOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
