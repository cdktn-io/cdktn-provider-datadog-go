...
func (j *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetHostmapDefinitionRequestSizeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetHostmapDefinitionRequestSizeOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetHostmapDefinitionRequestSizeOutputReference_Override(p PowerpackWidgetHostmapDefinitionRequestSizeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionRequestSizeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
