...
type PowerpackWidgetQueryTableDefinitionRequestFormulaCellDisplayModeOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/powerpack#trend_type Powerpack#trend_type}
	TrendType *string `field:"optional" json:"trendType" yaml:"trendType"`
	// The scale of the y-axis. Valid values are `shared`, `independent`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/powerpack#y_scale Powerpack#y_scale}
