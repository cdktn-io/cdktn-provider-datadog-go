...
func (j *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList {
	_init_.Initialize()
...
func NewPowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList_Override(p PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) Resolve(context cdktn.IResolveContext) interface{} {
