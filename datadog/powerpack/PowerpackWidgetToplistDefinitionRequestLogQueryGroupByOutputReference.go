...
func (j *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference_Override(p PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetToplistDefinitionRequestLogQueryGroupByOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
