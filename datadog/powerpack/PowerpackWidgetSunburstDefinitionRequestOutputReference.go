...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetSunburstDefinitionRequestOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PowerpackWidgetSunburstDefinitionRequestOutputReference {
	_init_.Initialize()
...
func NewPowerpackWidgetSunburstDefinitionRequestOutputReference_Override(p PowerpackWidgetSunburstDefinitionRequestOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
