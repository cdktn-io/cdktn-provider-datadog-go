...
type PowerpackWidgetChangeDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *PowerpackWidgetChangeDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
