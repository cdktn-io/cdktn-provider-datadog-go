...
func (j *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList {
	_init_.Initialize()
...
func NewPowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList_Override(p PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQueryEventQueryComputeList) Resolve(context cdktn.IResolveContext) interface{} {
