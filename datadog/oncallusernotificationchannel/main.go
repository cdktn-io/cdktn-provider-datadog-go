...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OnCallUserNotificationChannel)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putPhone", GoMethod: "PutPhone"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OnCallUserNotificationChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.onCallUserNotificationChannel.OnCallUserNotificationChannelEmail",
		reflect.TypeOf((*OnCallUserNotificationChannelEmail)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.onCallUserNotificationChannel.OnCallUserNotificationChannelEmailOutputReference",
		reflect.TypeOf((*OnCallUserNotificationChannelEmailOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OnCallUserNotificationChannelPhone)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.onCallUserNotificationChannel.OnCallUserNotificationChannelPhoneOutputReference",
		reflect.TypeOf((*OnCallUserNotificationChannelPhoneOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
