...
func (i *jsiiProxy_IntegrationAwsAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationAwsAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
