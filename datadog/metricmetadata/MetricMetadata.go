...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/metricmetadata/internal"
...
func (m *jsiiProxy_MetricMetadata) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MetricMetadata) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MetricMetadata) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
