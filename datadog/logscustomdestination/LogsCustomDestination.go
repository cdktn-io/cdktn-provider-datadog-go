...
func (l *jsiiProxy_LogsCustomDestination) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogsCustomDestination) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
