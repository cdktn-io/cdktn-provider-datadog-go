...
func (j *jsiiProxy_LogsCustomDestinationElasticsearchDestinationBasicAuthList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogsCustomDestinationElasticsearchDestinationBasicAuthList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LogsCustomDestinationElasticsearchDestinationBasicAuthList {
	_init_.Initialize()
...
func NewLogsCustomDestinationElasticsearchDestinationBasicAuthList_Override(l LogsCustomDestinationElasticsearchDestinationBasicAuthList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogsCustomDestinationElasticsearchDestinationBasicAuthList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogsCustomDestinationElasticsearchDestinationBasicAuthList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogsCustomDestinationElasticsearchDestinationBasicAuthList) Resolve(context cdktn.IResolveContext) interface{} {
