...
func (i *jsiiProxy_IntegrationGcpSts) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationGcpSts) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
