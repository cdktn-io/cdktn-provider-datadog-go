...
func (i *jsiiProxy_IntegrationGcpSts) validatePutMetricNamespaceConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*IntegrationGcpStsMetricNamespaceConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_IntegrationGcpSts) validatePutMonitoredResourceConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*IntegrationGcpStsMonitoredResourceConfigs; received %#v (a %T)", value, value)
		}
	}
