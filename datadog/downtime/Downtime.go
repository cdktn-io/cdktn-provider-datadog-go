...
func (d *jsiiProxy_Downtime) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_Downtime) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_Downtime) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
