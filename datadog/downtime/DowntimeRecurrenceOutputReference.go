...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v15/downtime/internal"
...
func (j *jsiiProxy_DowntimeRecurrenceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDowntimeRecurrenceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DowntimeRecurrenceOutputReference {
	_init_.Initialize()
...
func NewDowntimeRecurrenceOutputReference_Override(d DowntimeRecurrenceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DowntimeRecurrenceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DowntimeRecurrenceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DowntimeRecurrenceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DowntimeRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DowntimeRecurrenceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
