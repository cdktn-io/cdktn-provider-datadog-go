...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/teammembership/internal"
...
func (t *jsiiProxy_TeamMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TeamMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
