...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogOrgGroupMemberships)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "orgGroupId", GoGetter: "OrgGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "orgGroupIdInput", GoGetter: "OrgGroupIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOrgGroupId", GoMethod: "ResetOrgGroupId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogOrgGroupMembershipsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.dataDatadogOrgGroupMemberships.DataDatadogOrgGroupMembershipsMemberships",
		reflect.TypeOf((*DataDatadogOrgGroupMembershipsMemberships)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.dataDatadogOrgGroupMemberships.DataDatadogOrgGroupMembershipsMembershipsList",
		reflect.TypeOf((*DataDatadogOrgGroupMembershipsMembershipsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogOrgGroupMembershipsMembershipsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "orgSite", GoGetter: "OrgSite"},
			_jsii_.MemberProperty{JsiiProperty: "orgUuid", GoGetter: "OrgUuid"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
