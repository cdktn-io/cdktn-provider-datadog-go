...
type LogsArchiveConfig struct {
	...
	LookupAttributes *[]*string `field:"optional" json:"lookupAttributes" yaml:"lookupAttributes"`
	...
	PartitioningAttributes *[]*string `field:"optional" json:"partitioningAttributes" yaml:"partitioningAttributes"`
