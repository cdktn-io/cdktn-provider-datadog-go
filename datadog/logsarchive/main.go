...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "compressionMethod", GoGetter: "CompressionMethod"},
			_jsii_.MemberProperty{JsiiProperty: "compressionMethodInput", GoGetter: "CompressionMethodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCompressionMethod", GoMethod: "ResetCompressionMethod"},
