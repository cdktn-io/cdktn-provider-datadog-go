...
func (d *jsiiProxy_Datastore) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (d *jsiiProxy_Datastore) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
