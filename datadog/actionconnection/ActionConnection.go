...
func (a *jsiiProxy_ActionConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ActionConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
