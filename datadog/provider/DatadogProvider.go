...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/provider/internal"
...
func (d *jsiiProxy_DatadogProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatadogProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
