...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bearerToken", GoGetter: "BearerToken"},
			_jsii_.MemberProperty{JsiiProperty: "bearerTokenInput", GoGetter: "BearerTokenInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBearerToken", GoMethod: "ResetBearerToken"},
