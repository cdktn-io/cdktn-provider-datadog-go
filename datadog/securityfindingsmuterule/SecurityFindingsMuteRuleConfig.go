...
type SecurityFindingsMuteRuleConfig struct {
	// Experimental.
	...
	Action *SecurityFindingsMuteRuleAction `field:"required" json:"action" yaml:"action"`
	...
	Rule *SecurityFindingsMuteRuleRule `field:"required" json:"rule" yaml:"rule"`
