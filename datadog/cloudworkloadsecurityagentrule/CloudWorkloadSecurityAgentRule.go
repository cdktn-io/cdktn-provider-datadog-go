...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/cloudworkloadsecurityagentrule/internal"
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
