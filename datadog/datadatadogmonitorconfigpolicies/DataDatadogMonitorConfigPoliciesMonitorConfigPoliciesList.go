...
func (j *jsiiProxy_DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList {
	_init_.Initialize()
...
func NewDataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList_Override(d DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList) Resolve(context cdktn.IResolveContext) interface{} {
