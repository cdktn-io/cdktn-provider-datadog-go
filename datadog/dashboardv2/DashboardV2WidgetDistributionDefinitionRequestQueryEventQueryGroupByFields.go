...
type DashboardV2WidgetDistributionDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetDistributionDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
