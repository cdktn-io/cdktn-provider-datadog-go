...
type DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
