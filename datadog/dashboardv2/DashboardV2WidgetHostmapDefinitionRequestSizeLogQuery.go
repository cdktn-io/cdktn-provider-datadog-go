...
type DashboardV2WidgetHostmapDefinitionRequestSizeLogQuery struct {
	...
	ComputeQuery *DashboardV2WidgetHostmapDefinitionRequestSizeLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
