...
type DashboardV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
