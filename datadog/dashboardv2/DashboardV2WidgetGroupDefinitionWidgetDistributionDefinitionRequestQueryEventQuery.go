...
type DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
