...
type DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQuery struct {
	...
	ApmMetricsQuery *DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
