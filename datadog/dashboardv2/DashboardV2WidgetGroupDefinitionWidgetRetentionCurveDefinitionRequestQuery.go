...
type DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
