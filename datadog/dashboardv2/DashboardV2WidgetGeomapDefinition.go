...
type DashboardV2WidgetGeomapDefinition struct {
	// custom_link block.
	//
	...
	Style *DashboardV2WidgetGeomapDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGeomapDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	View *DashboardV2WidgetGeomapDefinitionView `field:"optional" json:"view" yaml:"view"`
}
