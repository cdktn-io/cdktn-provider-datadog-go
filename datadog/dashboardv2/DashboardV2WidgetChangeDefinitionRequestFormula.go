...
type DashboardV2WidgetChangeDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetChangeDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetChangeDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetChangeDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetChangeDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
