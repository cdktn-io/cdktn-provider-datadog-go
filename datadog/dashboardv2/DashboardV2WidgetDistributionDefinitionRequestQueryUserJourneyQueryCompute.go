...
type DashboardV2WidgetDistributionDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetDistributionDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
