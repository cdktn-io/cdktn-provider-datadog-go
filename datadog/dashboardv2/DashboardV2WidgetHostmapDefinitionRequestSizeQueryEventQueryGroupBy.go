...
type DashboardV2WidgetHostmapDefinitionRequestSizeQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *DashboardV2WidgetHostmapDefinitionRequestSizeQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
