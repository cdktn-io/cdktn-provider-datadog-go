...
type DashboardV2WidgetSunburstDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetSunburstDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
