...
type DashboardV2WidgetQueryTableDefinitionRequestQueryProductAnalyticsExtendedQueryCompute struct {
	...
	Rollup *DashboardV2WidgetQueryTableDefinitionRequestQueryProductAnalyticsExtendedQueryComputeRollup `field:"optional" json:"rollup" yaml:"rollup"`
}
