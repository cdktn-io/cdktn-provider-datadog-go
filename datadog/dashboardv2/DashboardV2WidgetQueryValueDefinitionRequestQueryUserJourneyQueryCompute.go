...
type DashboardV2WidgetQueryValueDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetQueryValueDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
