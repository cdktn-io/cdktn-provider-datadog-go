...
type DashboardV2WidgetCohortDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetCohortDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetCohortDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *DashboardV2WidgetCohortDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
