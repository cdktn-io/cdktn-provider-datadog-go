...
type DashboardV2WidgetRetentionCurveDefinitionRequest struct {
	// query block.
	//
	...
	Query *DashboardV2WidgetRetentionCurveDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
	...
	Style *DashboardV2WidgetRetentionCurveDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
