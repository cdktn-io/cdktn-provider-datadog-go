...
type DashboardV2WidgetQueryValueDefinitionRequestApmQuery struct {
	...
	ComputeQuery *DashboardV2WidgetQueryValueDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
