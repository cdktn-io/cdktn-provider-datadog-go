...
type DashboardV2WidgetLogStreamDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetLogStreamDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetLogStreamDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
