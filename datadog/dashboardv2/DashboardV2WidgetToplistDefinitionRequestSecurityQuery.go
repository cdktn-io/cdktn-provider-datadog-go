...
type DashboardV2WidgetToplistDefinitionRequestSecurityQuery struct {
	...
	ComputeQuery *DashboardV2WidgetToplistDefinitionRequestSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
