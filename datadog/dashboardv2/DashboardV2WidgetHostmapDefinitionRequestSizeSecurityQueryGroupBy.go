...
type DashboardV2WidgetHostmapDefinitionRequestSizeSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetHostmapDefinitionRequestSizeSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
