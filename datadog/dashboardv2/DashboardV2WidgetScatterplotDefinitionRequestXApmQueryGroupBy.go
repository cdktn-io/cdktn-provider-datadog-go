...
type DashboardV2WidgetScatterplotDefinitionRequestXApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetScatterplotDefinitionRequestXApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
