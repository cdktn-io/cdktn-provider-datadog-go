...
type DashboardV2WidgetSplitGraphDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetSplitGraphDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetSplitGraphDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
