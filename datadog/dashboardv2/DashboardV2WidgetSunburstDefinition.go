...
type DashboardV2WidgetSunburstDefinition struct {
	// custom_link block.
	//
	...
	LegendInline *DashboardV2WidgetSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	...
	LegendTable *DashboardV2WidgetSunburstDefinitionLegendTable `field:"optional" json:"legendTable" yaml:"legendTable"`
	...
	Time *DashboardV2WidgetSunburstDefinitionTime `field:"optional" json:"time" yaml:"time"`
