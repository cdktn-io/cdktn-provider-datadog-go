...
type DashboardV2WidgetGroupDefinitionWidgetToplistDefinition struct {
	// custom_link block.
	//
	...
	Style *DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTime `field:"optional" json:"time" yaml:"time"`
