...
type DashboardV2WidgetDistributionDefinitionRequestQueryProductAnalyticsExtendedQueryCompute struct {
	...
	Rollup *DashboardV2WidgetDistributionDefinitionRequestQueryProductAnalyticsExtendedQueryComputeRollup `field:"optional" json:"rollup" yaml:"rollup"`
}
