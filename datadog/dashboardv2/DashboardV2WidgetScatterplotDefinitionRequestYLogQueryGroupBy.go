...
type DashboardV2WidgetScatterplotDefinitionRequestYLogQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetScatterplotDefinitionRequestYLogQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
