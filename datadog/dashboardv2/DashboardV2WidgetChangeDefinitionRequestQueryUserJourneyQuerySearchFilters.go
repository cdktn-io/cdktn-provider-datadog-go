...
type DashboardV2WidgetChangeDefinitionRequestQueryUserJourneyQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetChangeDefinitionRequestQueryUserJourneyQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// graph_filter block.
	//
