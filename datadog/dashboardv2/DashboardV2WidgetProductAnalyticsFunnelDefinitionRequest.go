...
type DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest struct {
	// query block.
	//
	...
	Query *DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
	...
	ComparisonTime *DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestComparisonTime `field:"optional" json:"comparisonTime" yaml:"comparisonTime"`
}
