...
type DashboardV2WidgetSunburstDefinitionRequestLogQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetSunburstDefinitionRequestLogQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
