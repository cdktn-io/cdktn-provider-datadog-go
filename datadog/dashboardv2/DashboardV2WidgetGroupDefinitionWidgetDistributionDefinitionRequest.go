...
type DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequest struct {
	...
	HistogramQuery *DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestHistogramQuery `field:"optional" json:"histogramQuery" yaml:"histogramQuery"`
	// log_query block.
	//
