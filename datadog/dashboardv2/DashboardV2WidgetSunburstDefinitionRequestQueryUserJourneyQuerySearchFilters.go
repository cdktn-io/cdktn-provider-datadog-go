...
type DashboardV2WidgetSunburstDefinitionRequestQueryUserJourneyQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetSunburstDefinitionRequestQueryUserJourneyQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// graph_filter block.
	//
