...
type DashboardV2WidgetCohortDefinitionRequestQueryGroupBy struct {
	// Facet to group by.
	//
	...
	Sort *DashboardV2WidgetCohortDefinitionRequestQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
