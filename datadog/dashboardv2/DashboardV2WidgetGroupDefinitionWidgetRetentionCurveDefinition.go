...
type DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinition struct {
	// request block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetRetentionCurveDefinitionTime `field:"optional" json:"time" yaml:"time"`
