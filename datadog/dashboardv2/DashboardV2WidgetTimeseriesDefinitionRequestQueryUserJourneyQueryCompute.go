...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetTimeseriesDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
