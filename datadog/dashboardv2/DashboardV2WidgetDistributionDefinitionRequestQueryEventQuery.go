...
type DashboardV2WidgetDistributionDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetDistributionDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetDistributionDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
