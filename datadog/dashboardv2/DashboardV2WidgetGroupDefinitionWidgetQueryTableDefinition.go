...
type DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinition struct {
	// custom_link block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionTime `field:"optional" json:"time" yaml:"time"`
