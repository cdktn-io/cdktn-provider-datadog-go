...
type DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
