...
type DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
