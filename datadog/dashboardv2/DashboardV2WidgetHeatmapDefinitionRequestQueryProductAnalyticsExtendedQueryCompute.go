...
type DashboardV2WidgetHeatmapDefinitionRequestQueryProductAnalyticsExtendedQueryCompute struct {
	...
	Rollup *DashboardV2WidgetHeatmapDefinitionRequestQueryProductAnalyticsExtendedQueryComputeRollup `field:"optional" json:"rollup" yaml:"rollup"`
}
