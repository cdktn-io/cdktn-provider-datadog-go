...
type DashboardV2WidgetChangeDefinitionRequestRumQuery struct {
	...
	ComputeQuery *DashboardV2WidgetChangeDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
