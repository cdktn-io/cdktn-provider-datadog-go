...
type DashboardV2WidgetBarChartDefinitionRequestQuery struct {
	...
	ApmMetricsQuery *DashboardV2WidgetBarChartDefinitionRequestQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
	...
	ProductAnalyticsExtendedQuery *DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQuery `field:"optional" json:"productAnalyticsExtendedQuery" yaml:"productAnalyticsExtendedQuery"`
	...
	RetentionQuery *DashboardV2WidgetBarChartDefinitionRequestQueryRetentionQuery `field:"optional" json:"retentionQuery" yaml:"retentionQuery"`
	// slo_query block.
	//
	...
	UserJourneyQuery *DashboardV2WidgetBarChartDefinitionRequestQueryUserJourneyQuery `field:"optional" json:"userJourneyQuery" yaml:"userJourneyQuery"`
}
