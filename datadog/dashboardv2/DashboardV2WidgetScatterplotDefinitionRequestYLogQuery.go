...
type DashboardV2WidgetScatterplotDefinitionRequestYLogQuery struct {
	...
	ComputeQuery *DashboardV2WidgetScatterplotDefinitionRequestYLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
