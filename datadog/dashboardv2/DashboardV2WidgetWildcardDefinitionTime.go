...
type DashboardV2WidgetWildcardDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetWildcardDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetWildcardDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
