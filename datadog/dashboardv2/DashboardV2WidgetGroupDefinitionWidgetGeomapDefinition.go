...
type DashboardV2WidgetGroupDefinitionWidgetGeomapDefinition struct {
	// custom_link block.
	//
	...
	Style *DashboardV2WidgetGroupDefinitionWidgetGeomapDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetGeomapDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	View *DashboardV2WidgetGroupDefinitionWidgetGeomapDefinitionView `field:"optional" json:"view" yaml:"view"`
}
