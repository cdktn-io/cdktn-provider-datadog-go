...
type DashboardV2WidgetChangeDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetChangeDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
