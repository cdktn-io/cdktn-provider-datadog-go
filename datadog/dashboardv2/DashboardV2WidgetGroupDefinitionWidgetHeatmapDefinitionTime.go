...
type DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
