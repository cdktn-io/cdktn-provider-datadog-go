...
type DashboardV2WidgetQueryValueDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetQueryValueDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetQueryValueDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
