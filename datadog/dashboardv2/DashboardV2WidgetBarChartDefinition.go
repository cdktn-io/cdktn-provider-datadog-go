...
type DashboardV2WidgetBarChartDefinition struct {
	// custom_link block.
	//
	...
	Request *DashboardV2WidgetBarChartDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// style block.
	//
	...
	Style *DashboardV2WidgetBarChartDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetBarChartDefinitionTime `field:"optional" json:"time" yaml:"time"`
