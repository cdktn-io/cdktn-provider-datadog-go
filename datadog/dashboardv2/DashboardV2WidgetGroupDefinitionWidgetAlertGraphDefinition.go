...
type DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime `field:"optional" json:"time" yaml:"time"`
