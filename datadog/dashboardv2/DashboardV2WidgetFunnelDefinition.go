...
type DashboardV2WidgetFunnelDefinition struct {
	...
	Request *DashboardV2WidgetFunnelDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *DashboardV2WidgetFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
