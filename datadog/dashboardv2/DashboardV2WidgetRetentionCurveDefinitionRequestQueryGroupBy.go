...
type DashboardV2WidgetRetentionCurveDefinitionRequestQueryGroupBy struct {
	// Facet to group by.
	//
	...
	Sort *DashboardV2WidgetRetentionCurveDefinitionRequestQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
