...
type DashboardV2WidgetTreemapDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetTreemapDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetTreemapDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetTreemapDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetTreemapDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
