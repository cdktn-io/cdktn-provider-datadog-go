...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryUserJourneyQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetTimeseriesDefinitionRequestQueryUserJourneyQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetTimeseriesDefinitionRequestQueryUserJourneyQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
