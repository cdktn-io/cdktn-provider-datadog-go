...
type DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition struct {
	...
	Request *DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
