...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQuerySearch struct {
	...
	Filters *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	// join_keys block.
	//
	...
	JoinKeys *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQuerySearchJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
