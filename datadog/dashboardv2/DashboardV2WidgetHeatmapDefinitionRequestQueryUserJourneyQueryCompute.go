...
type DashboardV2WidgetHeatmapDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetHeatmapDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
