...
type DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
