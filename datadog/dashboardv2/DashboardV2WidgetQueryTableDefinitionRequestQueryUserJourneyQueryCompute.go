...
type DashboardV2WidgetQueryTableDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetQueryTableDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
