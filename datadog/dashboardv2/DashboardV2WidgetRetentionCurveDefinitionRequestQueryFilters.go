...
type DashboardV2WidgetRetentionCurveDefinitionRequestQueryFilters struct {
	...
	AudienceFilters *DashboardV2WidgetRetentionCurveDefinitionRequestQueryFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
