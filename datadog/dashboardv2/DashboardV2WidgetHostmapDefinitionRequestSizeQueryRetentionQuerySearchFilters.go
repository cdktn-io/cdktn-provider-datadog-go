...
type DashboardV2WidgetHostmapDefinitionRequestSizeQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetHostmapDefinitionRequestSizeQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
