...
type DashboardV2WidgetDistributionDefinitionRequestApmQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetDistributionDefinitionRequestApmQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
