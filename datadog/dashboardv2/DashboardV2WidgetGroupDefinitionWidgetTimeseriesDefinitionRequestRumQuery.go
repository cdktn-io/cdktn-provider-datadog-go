...
type DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestRumQuery struct {
	...
	ComputeQuery *DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
