...
type DashboardV2WidgetWildcardDefinitionRequestTreemapRequestLogQuery struct {
	...
	ComputeQuery *DashboardV2WidgetWildcardDefinitionRequestTreemapRequestLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
