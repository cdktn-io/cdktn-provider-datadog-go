...
type DashboardV2WidgetGroupDefinitionWidgetNoteDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTime `field:"optional" json:"time" yaml:"time"`
