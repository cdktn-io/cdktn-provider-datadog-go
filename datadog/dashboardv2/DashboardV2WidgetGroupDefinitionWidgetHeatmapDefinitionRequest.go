...
type DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequest struct {
	...
	HistogramRequest *DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionRequestHistogramRequest `field:"optional" json:"histogramRequest" yaml:"histogramRequest"`
	// log_query block.
	//
