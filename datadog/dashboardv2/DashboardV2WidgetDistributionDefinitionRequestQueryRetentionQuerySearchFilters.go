...
type DashboardV2WidgetDistributionDefinitionRequestQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetDistributionDefinitionRequestQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
