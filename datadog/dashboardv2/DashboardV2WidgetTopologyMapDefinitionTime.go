...
type DashboardV2WidgetTopologyMapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetTopologyMapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetTopologyMapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
