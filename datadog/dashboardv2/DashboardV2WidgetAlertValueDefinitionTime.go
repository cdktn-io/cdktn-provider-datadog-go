...
type DashboardV2WidgetAlertValueDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetAlertValueDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetAlertValueDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
