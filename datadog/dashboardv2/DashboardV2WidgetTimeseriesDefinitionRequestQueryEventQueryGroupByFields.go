...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
