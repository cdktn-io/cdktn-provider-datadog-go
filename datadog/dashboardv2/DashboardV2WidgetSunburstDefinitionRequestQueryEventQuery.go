...
type DashboardV2WidgetSunburstDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetSunburstDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetSunburstDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
