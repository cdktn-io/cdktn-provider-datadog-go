...
type DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillLogQuery struct {
	...
	ComputeQuery *DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestFillLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
