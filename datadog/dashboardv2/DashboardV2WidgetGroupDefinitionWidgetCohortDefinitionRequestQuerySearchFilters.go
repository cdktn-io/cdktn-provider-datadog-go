...
type DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
