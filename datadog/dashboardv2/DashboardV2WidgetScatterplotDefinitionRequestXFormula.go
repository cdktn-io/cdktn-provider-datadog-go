...
type DashboardV2WidgetScatterplotDefinitionRequestXFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetScatterplotDefinitionRequestXFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetScatterplotDefinitionRequestXFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetScatterplotDefinitionRequestXFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
