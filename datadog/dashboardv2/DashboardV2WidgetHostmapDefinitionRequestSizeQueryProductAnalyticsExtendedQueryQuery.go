...
type DashboardV2WidgetHostmapDefinitionRequestSizeQueryProductAnalyticsExtendedQueryQuery struct {
	...
	Search *DashboardV2WidgetHostmapDefinitionRequestSizeQueryProductAnalyticsExtendedQueryQuerySearch `field:"required" json:"search" yaml:"search"`
}
