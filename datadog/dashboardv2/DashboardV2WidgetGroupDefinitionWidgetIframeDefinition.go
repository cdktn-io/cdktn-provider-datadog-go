...
type DashboardV2WidgetGroupDefinitionWidgetIframeDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTime `field:"optional" json:"time" yaml:"time"`
