...
type DashboardV2WidgetTreemapDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetTreemapDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetTreemapDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
