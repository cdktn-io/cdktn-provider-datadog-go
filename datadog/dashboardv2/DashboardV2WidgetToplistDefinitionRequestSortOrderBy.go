...
type DashboardV2WidgetToplistDefinitionRequestSortOrderBy struct {
	// formula_sort block.
	//
	...
	FormulaSort *DashboardV2WidgetToplistDefinitionRequestSortOrderByFormulaSort `field:"optional" json:"formulaSort" yaml:"formulaSort"`
	// group_sort block.
	//
	...
	GroupSort *DashboardV2WidgetToplistDefinitionRequestSortOrderByGroupSort `field:"optional" json:"groupSort" yaml:"groupSort"`
}
