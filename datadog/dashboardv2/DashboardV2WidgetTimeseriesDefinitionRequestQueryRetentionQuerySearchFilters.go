...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetTimeseriesDefinitionRequestQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
