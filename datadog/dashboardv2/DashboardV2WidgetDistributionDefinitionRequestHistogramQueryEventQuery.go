...
type DashboardV2WidgetDistributionDefinitionRequestHistogramQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetDistributionDefinitionRequestHistogramQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetDistributionDefinitionRequestHistogramQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
