...
type DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQuery struct {
	...
	AudienceFilters *DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// Entries per step.
	//
	...
	JoinKeys *DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
	// Number of steps.
	//
	...
	Occurrence *DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryOccurrence `field:"optional" json:"occurrence" yaml:"occurrence"`
	// Source field.
	//
