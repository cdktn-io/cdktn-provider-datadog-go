...
type DashboardV2WidgetScatterplotDefinitionRequestYQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetScatterplotDefinitionRequestYQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetScatterplotDefinitionRequestYQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
