...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryRetentionQuerySearchCohortCriteriaBaseQuery struct {
	...
	Search *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryRetentionQuerySearchCohortCriteriaBaseQuerySearch `field:"required" json:"search" yaml:"search"`
}
