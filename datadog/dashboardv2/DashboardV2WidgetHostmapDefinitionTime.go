...
type DashboardV2WidgetHostmapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetHostmapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetHostmapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
