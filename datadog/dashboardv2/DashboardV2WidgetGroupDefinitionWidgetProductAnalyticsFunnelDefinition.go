...
type DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinition struct {
	// request block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
