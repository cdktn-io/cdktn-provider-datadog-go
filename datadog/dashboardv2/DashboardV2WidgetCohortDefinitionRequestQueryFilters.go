...
type DashboardV2WidgetCohortDefinitionRequestQueryFilters struct {
	...
	AudienceFilters *DashboardV2WidgetCohortDefinitionRequestQueryFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
