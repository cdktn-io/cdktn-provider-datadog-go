...
type DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProductAnalyticsExtendedQueryQuery struct {
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProductAnalyticsExtendedQueryQuerySearch `field:"required" json:"search" yaml:"search"`
}
