...
type DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition struct {
	// request block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
