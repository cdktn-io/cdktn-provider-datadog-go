...
func (d *jsiiProxy_DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersOutputReference) validatePutAccountParameters(value interface{}) error {
	...
	case *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersAccount:
		value := value.(*[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersAccount)
	...
	case []*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersAccount:
		value_ := value.([]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersAccount)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersAccount; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersOutputReference) validatePutSegmentParameters(value interface{}) error {
	...
	case *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersSegment:
		value := value.(*[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersSegment)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersSegment:
		value_ := value.([]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersSegment)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersSegment; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersOutputReference) validatePutUserParameters(value interface{}) error {
	...
	case *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersUser:
		value := value.(*[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersUser)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersUser:
		value_ := value.([]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersUser)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardV2WidgetBarChartDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFiltersUser; received %#v (a %T)", value, value)
		}
	}
