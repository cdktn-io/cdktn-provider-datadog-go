...
type DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime `field:"optional" json:"time" yaml:"time"`
