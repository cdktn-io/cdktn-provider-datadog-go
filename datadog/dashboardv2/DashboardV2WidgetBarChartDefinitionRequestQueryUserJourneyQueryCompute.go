...
type DashboardV2WidgetBarChartDefinitionRequestQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetBarChartDefinitionRequestQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
