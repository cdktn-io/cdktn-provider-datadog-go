...
type DashboardV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestXQueryRetentionQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestXQueryRetentionQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetScatterplotDefinitionRequestXQueryRetentionQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
