...
type DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequest struct {
	// apm_query block.
	//
	...
	ApmQuery *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	LogQuery *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// style block.
	//
	...
	Style *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestStyle `field:"optional" json:"style" yaml:"style"`
}
