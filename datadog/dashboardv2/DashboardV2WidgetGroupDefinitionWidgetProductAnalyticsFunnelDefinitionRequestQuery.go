...
type DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestQuery struct {
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// compute block.
	//
	...
	Compute *DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestQueryCompute `field:"optional" json:"compute" yaml:"compute"`
	// group_by block.
	//
