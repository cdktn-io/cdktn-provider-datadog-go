...
type DashboardV2WidgetWildcardDefinition struct {
	// custom_link block.
	//
	...
	Specification *DashboardV2WidgetWildcardDefinitionSpecification `field:"optional" json:"specification" yaml:"specification"`
	// time block.
	//
	...
	Time *DashboardV2WidgetWildcardDefinitionTime `field:"optional" json:"time" yaml:"time"`
