...
type DashboardV2WidgetTimeseriesDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetTimeseriesDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetTimeseriesDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
