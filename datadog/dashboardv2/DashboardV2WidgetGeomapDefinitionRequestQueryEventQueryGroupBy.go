...
type DashboardV2WidgetGeomapDefinitionRequestQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *DashboardV2WidgetGeomapDefinitionRequestQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
