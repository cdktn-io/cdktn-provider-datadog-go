...
type DashboardV2WidgetHeatmapDefinitionRequestSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetHeatmapDefinitionRequestSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
