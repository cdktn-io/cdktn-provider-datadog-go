...
type DashboardV2WidgetGeomapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetGeomapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetGeomapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
