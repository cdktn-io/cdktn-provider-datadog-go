...
type DashboardV2WidgetHeatmapDefinition struct {
	// custom_link block.
	//
	...
	Time *DashboardV2WidgetHeatmapDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *DashboardV2WidgetHeatmapDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *DashboardV2WidgetHeatmapDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
