...
type DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime `field:"optional" json:"time" yaml:"time"`
