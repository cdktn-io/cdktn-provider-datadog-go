...
type DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryFilters struct {
	...
	AudienceFilters *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
