...
type DashboardV2WidgetTimeseriesDefinitionRequestApmQuery struct {
	...
	ComputeQuery *DashboardV2WidgetTimeseriesDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
