...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinition struct {
	// custom_link block.
	//
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTime `field:"optional" json:"time" yaml:"time"`
