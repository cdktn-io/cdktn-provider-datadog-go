...
type DashboardV2WidgetDistributionDefinitionRequestApmQuery struct {
	...
	ComputeQuery *DashboardV2WidgetDistributionDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
