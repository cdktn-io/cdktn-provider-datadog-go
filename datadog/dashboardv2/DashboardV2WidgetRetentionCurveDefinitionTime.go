...
type DashboardV2WidgetRetentionCurveDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetRetentionCurveDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetRetentionCurveDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
