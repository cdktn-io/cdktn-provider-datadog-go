...
type DashboardV2WidgetTimeseriesDefinitionRequestEventQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardV2WidgetTimeseriesDefinitionRequestEventQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
