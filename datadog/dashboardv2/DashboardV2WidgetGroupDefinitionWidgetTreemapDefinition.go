...
type DashboardV2WidgetGroupDefinitionWidgetTreemapDefinition struct {
	// custom_links block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTime `field:"optional" json:"time" yaml:"time"`
