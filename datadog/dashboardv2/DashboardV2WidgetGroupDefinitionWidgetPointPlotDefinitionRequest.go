...
type DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionRequest struct {
	// projection block.
	//
	...
	Projection *DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionRequestProjection `field:"required" json:"projection" yaml:"projection"`
	// query block.
	//
	...
	Query *DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionRequestQuery `field:"required" json:"query" yaml:"query"`
