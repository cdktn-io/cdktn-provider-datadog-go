...
type DashboardV2WidgetQueryTableDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetQueryTableDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
