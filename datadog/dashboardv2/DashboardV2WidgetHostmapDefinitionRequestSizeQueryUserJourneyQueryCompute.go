...
type DashboardV2WidgetHostmapDefinitionRequestSizeQueryUserJourneyQueryCompute struct {
	...
	Target *DashboardV2WidgetHostmapDefinitionRequestSizeQueryUserJourneyQueryComputeTarget `field:"optional" json:"target" yaml:"target"`
}
