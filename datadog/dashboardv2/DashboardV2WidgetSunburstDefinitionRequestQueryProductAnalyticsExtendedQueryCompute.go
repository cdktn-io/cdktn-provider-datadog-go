...
type DashboardV2WidgetSunburstDefinitionRequestQueryProductAnalyticsExtendedQueryCompute struct {
	...
	Rollup *DashboardV2WidgetSunburstDefinitionRequestQueryProductAnalyticsExtendedQueryComputeRollup `field:"optional" json:"rollup" yaml:"rollup"`
}
