...
type DashboardV2WidgetCohortDefinitionRequestQuerySearch struct {
	...
	CohortCriteria *DashboardV2WidgetCohortDefinitionRequestQuerySearchCohortCriteria `field:"required" json:"cohortCriteria" yaml:"cohortCriteria"`
	...
	Filters *DashboardV2WidgetCohortDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	...
	ReturnCriteria *DashboardV2WidgetCohortDefinitionRequestQuerySearchReturnCriteria `field:"optional" json:"returnCriteria" yaml:"returnCriteria"`
}
