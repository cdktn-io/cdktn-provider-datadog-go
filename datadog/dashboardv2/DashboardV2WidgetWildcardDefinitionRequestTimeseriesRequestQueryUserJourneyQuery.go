...
type DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryUserJourneyQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryUserJourneyQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryUserJourneyQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
