...
type DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQuerySearch `field:"required" json:"search" yaml:"search"`
	// filters block.
	//
	...
	Filters *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestQueryFilters `field:"optional" json:"filters" yaml:"filters"`
	// group_by block.
	//
