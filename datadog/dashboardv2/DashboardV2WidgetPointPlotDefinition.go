...
type DashboardV2WidgetPointPlotDefinition struct {
	// custom_link block.
	//
	...
	Legend *DashboardV2WidgetPointPlotDefinitionLegend `field:"optional" json:"legend" yaml:"legend"`
	...
	Time *DashboardV2WidgetPointPlotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Yaxis *DashboardV2WidgetPointPlotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
