...
type DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinition struct {
	// custom_link block.
	//
	...
	Legend *DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionLegend `field:"optional" json:"legend" yaml:"legend"`
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Yaxis *DashboardV2WidgetGroupDefinitionWidgetPointPlotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
