...
type DashboardV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaTimeInterval struct {
	...
	Value *DashboardV2WidgetCohortDefinitionRequestQuerySearchCohortCriteriaTimeIntervalValue `field:"required" json:"value" yaml:"value"`
}
