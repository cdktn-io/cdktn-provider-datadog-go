...
type DashboardV2WidgetGroupDefinitionWidgetBarChartDefinition struct {
	// custom_link block.
	//
	...
	Request *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// style block.
	//
	...
	Style *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetBarChartDefinitionTime `field:"optional" json:"time" yaml:"time"`
