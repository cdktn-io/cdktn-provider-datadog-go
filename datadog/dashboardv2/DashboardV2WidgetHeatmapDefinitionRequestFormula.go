...
type DashboardV2WidgetHeatmapDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetHeatmapDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetHeatmapDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
