...
type DashboardV2WidgetHeatmapDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetHeatmapDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetHeatmapDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
