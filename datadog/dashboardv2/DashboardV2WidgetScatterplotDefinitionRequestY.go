...
type DashboardV2WidgetScatterplotDefinitionRequestY struct {
	...
	ApmQuery *DashboardV2WidgetScatterplotDefinitionRequestYApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// formula block.
	//
	...
	LogQuery *DashboardV2WidgetScatterplotDefinitionRequestYLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardV2WidgetScatterplotDefinitionRequestYRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardV2WidgetScatterplotDefinitionRequestYSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
