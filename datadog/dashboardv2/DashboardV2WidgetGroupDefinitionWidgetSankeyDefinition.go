...
type DashboardV2WidgetGroupDefinitionWidgetSankeyDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionTime `field:"optional" json:"time" yaml:"time"`
