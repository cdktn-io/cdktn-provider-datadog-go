...
type DashboardV2WidgetLogStreamDefinition struct {
	...
	Sort *DashboardV2WidgetLogStreamDefinitionSort `field:"optional" json:"sort" yaml:"sort"`
	// time block.
	//
	...
	Time *DashboardV2WidgetLogStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
