...
type DashboardV2WidgetServiceLevelObjectiveDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetServiceLevelObjectiveDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetServiceLevelObjectiveDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
