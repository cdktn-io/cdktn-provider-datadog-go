...
type DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinition struct {
	// APM environment.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTime `field:"optional" json:"time" yaml:"time"`
