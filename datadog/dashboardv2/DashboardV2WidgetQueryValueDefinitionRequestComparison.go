...
type DashboardV2WidgetQueryValueDefinitionRequestComparison struct {
	// duration block.
	//
	...
	Duration *DashboardV2WidgetQueryValueDefinitionRequestComparisonDuration `field:"required" json:"duration" yaml:"duration"`
