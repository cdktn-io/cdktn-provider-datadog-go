...
type DashboardV2WidgetSunburstDefinitionRequestQueryEventQueryGroupByFields struct {
	...
	Sort *DashboardV2WidgetSunburstDefinitionRequestQueryEventQueryGroupByFieldsSort `field:"optional" json:"sort" yaml:"sort"`
}
