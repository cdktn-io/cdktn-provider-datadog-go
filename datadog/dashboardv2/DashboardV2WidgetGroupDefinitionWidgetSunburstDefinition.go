...
type DashboardV2WidgetGroupDefinitionWidgetSunburstDefinition struct {
	// custom_link block.
	//
	...
	LegendInline *DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	...
	LegendTable *DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTable `field:"optional" json:"legendTable" yaml:"legendTable"`
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTime `field:"optional" json:"time" yaml:"time"`
