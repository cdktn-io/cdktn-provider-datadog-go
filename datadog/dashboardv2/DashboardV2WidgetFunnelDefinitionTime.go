...
type DashboardV2WidgetFunnelDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetFunnelDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetFunnelDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
