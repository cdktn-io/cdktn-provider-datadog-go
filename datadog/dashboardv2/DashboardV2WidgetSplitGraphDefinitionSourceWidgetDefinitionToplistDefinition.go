...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionToplistDefinition struct {
	// custom_link block.
	//
	...
	Style *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionToplistDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionToplistDefinitionTime `field:"optional" json:"time" yaml:"time"`
