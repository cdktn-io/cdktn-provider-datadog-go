...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionScatterplotDefinition struct {
	...
	Request *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionScatterplotDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionScatterplotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionScatterplotDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionScatterplotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
