...
type DashboardV2WidgetPowerpackDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetPowerpackDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetPowerpackDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
