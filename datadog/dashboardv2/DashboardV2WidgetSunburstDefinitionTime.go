...
type DashboardV2WidgetSunburstDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetSunburstDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetSunburstDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
