...
type DashboardV2WidgetToplistDefinitionRequestQuery struct {
	...
	ApmMetricsQuery *DashboardV2WidgetToplistDefinitionRequestQueryApmMetricsQuery `field:"optional" json:"apmMetricsQuery" yaml:"apmMetricsQuery"`
	...
	ProductAnalyticsExtendedQuery *DashboardV2WidgetToplistDefinitionRequestQueryProductAnalyticsExtendedQuery `field:"optional" json:"productAnalyticsExtendedQuery" yaml:"productAnalyticsExtendedQuery"`
	...
	RetentionQuery *DashboardV2WidgetToplistDefinitionRequestQueryRetentionQuery `field:"optional" json:"retentionQuery" yaml:"retentionQuery"`
	// slo_query block.
	//
	...
	UserJourneyQuery *DashboardV2WidgetToplistDefinitionRequestQueryUserJourneyQuery `field:"optional" json:"userJourneyQuery" yaml:"userJourneyQuery"`
}
