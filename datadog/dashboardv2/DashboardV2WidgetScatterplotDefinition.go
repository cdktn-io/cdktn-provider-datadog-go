...
type DashboardV2WidgetScatterplotDefinition struct {
	...
	Request *DashboardV2WidgetScatterplotDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	// time block.
	//
	...
	Time *DashboardV2WidgetScatterplotDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	Xaxis *DashboardV2WidgetScatterplotDefinitionXaxis `field:"optional" json:"xaxis" yaml:"xaxis"`
	// yaxis block.
	//
	...
	Yaxis *DashboardV2WidgetScatterplotDefinitionYaxis `field:"optional" json:"yaxis" yaml:"yaxis"`
}
