...
type DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryRetentionQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryRetentionQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Search *DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryRetentionQuerySearch `field:"required" json:"search" yaml:"search"`
	// group_by block.
	//
