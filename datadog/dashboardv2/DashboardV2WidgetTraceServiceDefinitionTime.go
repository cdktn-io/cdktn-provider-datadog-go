...
type DashboardV2WidgetTraceServiceDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetTraceServiceDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetTraceServiceDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
