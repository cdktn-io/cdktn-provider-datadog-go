...
type DashboardV2WidgetProductAnalyticsFunnelDefinition struct {
	// request block.
	//
	...
	Time *DashboardV2WidgetProductAnalyticsFunnelDefinitionTime `field:"optional" json:"time" yaml:"time"`
