...
type DashboardV2WidgetGroupDefinitionWidgetCohortDefinition struct {
	// request block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTime `field:"optional" json:"time" yaml:"time"`
