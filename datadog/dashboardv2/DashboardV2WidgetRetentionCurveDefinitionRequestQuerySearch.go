...
type DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearch struct {
	...
	CohortCriteria *DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearchCohortCriteria `field:"required" json:"cohortCriteria" yaml:"cohortCriteria"`
	...
	Filters *DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	...
	ReturnCriteria *DashboardV2WidgetRetentionCurveDefinitionRequestQuerySearchReturnCriteria `field:"optional" json:"returnCriteria" yaml:"returnCriteria"`
}
