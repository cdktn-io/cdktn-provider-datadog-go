...
type DashboardV2WidgetTimeseriesDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetTimeseriesDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetTimeseriesDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
