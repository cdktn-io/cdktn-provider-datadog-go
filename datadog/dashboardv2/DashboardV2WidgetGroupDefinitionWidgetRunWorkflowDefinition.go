...
type DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinition struct {
	// Workflow ID.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTime `field:"optional" json:"time" yaml:"time"`
