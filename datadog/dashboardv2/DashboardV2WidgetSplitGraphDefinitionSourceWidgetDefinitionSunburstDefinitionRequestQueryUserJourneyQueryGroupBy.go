...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQueryGroupBy struct {
	...
	Sort *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
	// target block.
	//
	...
	Target *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestQueryUserJourneyQueryGroupByTarget `field:"optional" json:"target" yaml:"target"`
}
