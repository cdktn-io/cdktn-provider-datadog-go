...
type DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime `field:"optional" json:"time" yaml:"time"`
