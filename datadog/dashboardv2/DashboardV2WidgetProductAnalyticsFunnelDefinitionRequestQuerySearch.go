...
type DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearch struct {
	...
	Filters *DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearchFilters `field:"optional" json:"filters" yaml:"filters"`
	// join_keys block.
	//
	...
	JoinKeys *DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestQuerySearchJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
