...
type DashboardV2WidgetHeatmapDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetHeatmapDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetHeatmapDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
