...
type DashboardV2WidgetWildcardDefinitionRequestTreemapRequestApmQuery struct {
	...
	ComputeQuery *DashboardV2WidgetWildcardDefinitionRequestTreemapRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
