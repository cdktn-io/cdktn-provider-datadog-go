...
type DashboardV2WidgetGroupDefinitionWidgetWildcardDefinition struct {
	...
	// specification block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/dashboard_v2#specification DashboardV2#specification}
