...
type DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime `field:"optional" json:"time" yaml:"time"`
