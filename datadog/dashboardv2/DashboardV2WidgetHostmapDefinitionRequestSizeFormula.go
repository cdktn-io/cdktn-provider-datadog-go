...
type DashboardV2WidgetHostmapDefinitionRequestSizeFormula struct {
	...
	CellDisplayModeOptions *DashboardV2WidgetHostmapDefinitionRequestSizeFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardV2WidgetHostmapDefinitionRequestSizeFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardV2WidgetHostmapDefinitionRequestSizeFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
