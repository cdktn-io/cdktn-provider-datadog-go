...
type DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest struct {
	...
	ApmQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// audit_query block.
	//
	...
	AuditQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestAuditQuery `field:"optional" json:"auditQuery" yaml:"auditQuery"`
	// comparison block.
	//
	...
	Comparison *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestComparison `field:"optional" json:"comparison" yaml:"comparison"`
	...
	LogQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
