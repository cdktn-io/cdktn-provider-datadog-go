...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinition struct {
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTime `field:"optional" json:"time" yaml:"time"`
	...
	TimeseriesBackground *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackground `field:"optional" json:"timeseriesBackground" yaml:"timeseriesBackground"`
