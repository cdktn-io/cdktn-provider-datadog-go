...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionTreemapDefinition struct {
	// custom_links block.
	//
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionTreemapDefinitionTime `field:"optional" json:"time" yaml:"time"`
