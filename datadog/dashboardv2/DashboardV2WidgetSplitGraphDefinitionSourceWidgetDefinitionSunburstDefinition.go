...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition struct {
	// custom_link block.
	//
	...
	LegendInline *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	...
	LegendTable *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTable `field:"optional" json:"legendTable" yaml:"legendTable"`
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionTime `field:"optional" json:"time" yaml:"time"`
