...
type DashboardV2WidgetSankeyDefinitionRequestRumRequestQuery struct {
	...
	AudienceFilters *DashboardV2WidgetSankeyDefinitionRequestRumRequestQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// Entries per step.
	//
	...
	JoinKeys *DashboardV2WidgetSankeyDefinitionRequestRumRequestQueryJoinKeys `field:"optional" json:"joinKeys" yaml:"joinKeys"`
	// Number of steps.
	//
	...
	Occurrence *DashboardV2WidgetSankeyDefinitionRequestRumRequestQueryOccurrence `field:"optional" json:"occurrence" yaml:"occurrence"`
	// Source field.
	//
