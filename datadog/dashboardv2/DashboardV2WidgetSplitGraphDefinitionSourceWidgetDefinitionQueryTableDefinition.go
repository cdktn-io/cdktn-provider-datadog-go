...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryTableDefinition struct {
	// custom_link block.
	//
	...
	Time *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryTableDefinitionTime `field:"optional" json:"time" yaml:"time"`
