...
type DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinition struct {
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime `field:"optional" json:"time" yaml:"time"`
