...
type DashboardV2WidgetQueryTableDefinitionRequestApmQuery struct {
	...
	ComputeQuery *DashboardV2WidgetQueryTableDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
