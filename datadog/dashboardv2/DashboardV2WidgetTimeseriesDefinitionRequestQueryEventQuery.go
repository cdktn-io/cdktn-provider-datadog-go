...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryEventQuery struct {
	// compute block.
	//
	...
	GroupByFields *DashboardV2WidgetTimeseriesDefinitionRequestQueryEventQueryGroupByFields `field:"optional" json:"groupByFields" yaml:"groupByFields"`
	...
	Search *DashboardV2WidgetTimeseriesDefinitionRequestQueryEventQuerySearch `field:"optional" json:"search" yaml:"search"`
