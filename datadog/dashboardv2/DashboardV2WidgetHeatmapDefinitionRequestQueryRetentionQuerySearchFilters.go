...
type DashboardV2WidgetHeatmapDefinitionRequestQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetHeatmapDefinitionRequestQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
