...
type DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Query *DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryQuery `field:"required" json:"query" yaml:"query"`
	...
	AudienceFilters *DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// group_by block.
	//
