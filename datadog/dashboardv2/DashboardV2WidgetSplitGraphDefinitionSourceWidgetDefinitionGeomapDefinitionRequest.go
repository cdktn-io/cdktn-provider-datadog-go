...
type DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionGeomapDefinitionRequest struct {
	// formula block.
	//
	...
	LogQuery *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionGeomapDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	...
	RumQuery *DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionGeomapDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
}
