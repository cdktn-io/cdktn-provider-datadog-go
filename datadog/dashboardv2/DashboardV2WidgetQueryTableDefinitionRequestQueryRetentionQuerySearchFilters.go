...
type DashboardV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetQueryTableDefinitionRequestQueryRetentionQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
