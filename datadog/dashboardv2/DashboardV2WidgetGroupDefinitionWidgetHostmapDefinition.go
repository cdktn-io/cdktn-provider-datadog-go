...
type DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition struct {
	// custom_link block.
	//
	...
	Request *DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest `field:"optional" json:"request" yaml:"request"`
	...
	Style *DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle `field:"optional" json:"style" yaml:"style"`
	// time block.
	//
	...
	Time *DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTime `field:"optional" json:"time" yaml:"time"`
