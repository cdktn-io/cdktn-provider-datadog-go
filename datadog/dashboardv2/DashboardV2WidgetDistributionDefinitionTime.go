...
type DashboardV2WidgetDistributionDefinitionTime struct {
	// fixed block.
	//
	...
	Fixed *DashboardV2WidgetDistributionDefinitionTimeFixed `field:"optional" json:"fixed" yaml:"fixed"`
	// live block.
	//
	...
	Live *DashboardV2WidgetDistributionDefinitionTimeLive `field:"optional" json:"live" yaml:"live"`
}
