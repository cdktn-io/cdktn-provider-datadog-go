...
type DashboardV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQuery struct {
	// compute block.
	//
	...
	Compute *DashboardV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQueryCompute `field:"required" json:"compute" yaml:"compute"`
	...
	Query *DashboardV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQueryQuery `field:"required" json:"query" yaml:"query"`
	...
	AudienceFilters *DashboardV2WidgetTimeseriesDefinitionRequestQueryProductAnalyticsExtendedQueryAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// group_by block.
	//
