...
type DashboardV2WidgetHostmapDefinitionRequestFillQueryUserJourneyQuerySearchFilters struct {
	...
	AudienceFilters *DashboardV2WidgetHostmapDefinitionRequestFillQueryUserJourneyQuerySearchFiltersAudienceFilters `field:"optional" json:"audienceFilters" yaml:"audienceFilters"`
	// graph_filter block.
	//
