...
type DashboardV2WidgetQueryTableDefinitionRequest struct {
	...
	ApmQuery *DashboardV2WidgetQueryTableDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	ApmStatsQuery *DashboardV2WidgetQueryTableDefinitionRequestApmStatsQuery `field:"optional" json:"apmStatsQuery" yaml:"apmStatsQuery"`
	...
	LogQuery *DashboardV2WidgetQueryTableDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	...
	ProcessQuery *DashboardV2WidgetQueryTableDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardV2WidgetQueryTableDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardV2WidgetQueryTableDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// sort block.
	//
	...
	Sort *DashboardV2WidgetQueryTableDefinitionRequestSort `field:"optional" json:"sort" yaml:"sort"`
	// text_formats block.
	//
