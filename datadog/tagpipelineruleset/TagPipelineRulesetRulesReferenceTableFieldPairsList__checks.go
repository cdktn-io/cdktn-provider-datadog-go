...
func (t *jsiiProxy_TagPipelineRulesetRulesReferenceTableFieldPairsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_TagPipelineRulesetRulesReferenceTableFieldPairsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewTagPipelineRulesetRulesReferenceTableFieldPairsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
