...
import (
	...
	"github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/agentlessscanningawsscanoptions/internal"
...
func (a *jsiiProxy_AgentlessScanningAwsScanOptions) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AgentlessScanningAwsScanOptions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AgentlessScanningAwsScanOptions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
