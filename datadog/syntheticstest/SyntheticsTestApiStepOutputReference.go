...
func (j *jsiiProxy_SyntheticsTestApiStepOutputReference) SubtestPublicId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subtestPublicId",
...
func (j *jsiiProxy_SyntheticsTestApiStepOutputReference) SubtestPublicIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsTestApiStepOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsTestApiStepOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsTestApiStepOutputReference {
	_init_.Initialize()
...
func NewSyntheticsTestApiStepOutputReference_Override(s SyntheticsTestApiStepOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsTestApiStepOutputReference)SetSubtestPublicId(val *string) {
...
func (j *jsiiProxy_SyntheticsTestApiStepOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsTestApiStepOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestApiStepOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsTestApiStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestApiStepOutputReference) ResetSubtestPublicId() {
	_jsii_.InvokeVoid(
		s,
		"resetSubtestPublicId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsTestApiStepOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
