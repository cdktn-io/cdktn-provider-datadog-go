...
func (j *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsTestMobileStepParamsPositionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsTestMobileStepParamsPositionsOutputReference {
	_init_.Initialize()
...
func NewSyntheticsTestMobileStepParamsPositionsOutputReference_Override(s SyntheticsTestMobileStepParamsPositionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsPositionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
