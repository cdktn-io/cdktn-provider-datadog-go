...
func (s *jsiiProxy_SyntheticsTest) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SyntheticsTest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
