...
func (j *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsTestAssertionTargetjsonpathOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SyntheticsTestAssertionTargetjsonpathOutputReference {
	_init_.Initialize()
...
func NewSyntheticsTestAssertionTargetjsonpathOutputReference_Override(s SyntheticsTestAssertionTargetjsonpathOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestAssertionTargetjsonpathOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
