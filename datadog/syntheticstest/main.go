...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addClaimsExp", GoGetter: "AddClaimsExp"},
			_jsii_.MemberProperty{JsiiProperty: "addClaimsExpInput", GoGetter: "AddClaimsExpInput"},
			_jsii_.MemberProperty{JsiiProperty: "addClaimsIat", GoGetter: "AddClaimsIat"},
			_jsii_.MemberProperty{JsiiProperty: "addClaimsIatInput", GoGetter: "AddClaimsIatInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAddClaimsExp", GoMethod: "ResetAddClaimsExp"},
			_jsii_.MemberMethod{JsiiMethod: "resetAddClaimsIat", GoMethod: "ResetAddClaimsIat"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTokenPrefix", GoMethod: "ResetTokenPrefix"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tokenPrefix", GoGetter: "TokenPrefix"},
			_jsii_.MemberProperty{JsiiProperty: "tokenPrefixInput", GoGetter: "TokenPrefixInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "type", GoGetter: "Type"},
			_jsii_.MemberProperty{JsiiProperty: "typeInput", GoGetter: "TypeInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "destinationService", GoGetter: "DestinationService"},
			_jsii_.MemberProperty{JsiiProperty: "destinationServiceInput", GoGetter: "DestinationServiceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "e2EQueries", GoGetter: "E2EQueries"},
			_jsii_.MemberProperty{JsiiProperty: "e2EQueriesInput", GoGetter: "E2EQueriesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationService", GoMethod: "ResetDestinationService"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetE2EQueries", GoMethod: "ResetE2EQueries"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceService", GoGetter: "SourceService"},
			_jsii_.MemberProperty{JsiiProperty: "sourceServiceInput", GoGetter: "SourceServiceInput"},
			_jsii_.MemberProperty{JsiiProperty: "tcpMethod", GoGetter: "TcpMethod"},
			_jsii_.MemberProperty{JsiiProperty: "tcpMethodInput", GoGetter: "TcpMethodInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SyntheticsTestBrowserStepParamsDragDropOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-datadog.syntheticsTest.SyntheticsTestBrowserStepParamsDragDropOptionsOffset",
		reflect.TypeOf((*SyntheticsTestBrowserStepParamsDragDropOptionsOffset)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-datadog.syntheticsTest.SyntheticsTestBrowserStepParamsDragDropOptionsOffsetOutputReference",
		reflect.TypeOf((*SyntheticsTestBrowserStepParamsDragDropOptionsOffsetOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SyntheticsTestBrowserStepParamsDragDropOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putOffset", GoMethod: "PutOffset"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "delay", GoGetter: "Delay"},
			_jsii_.MemberProperty{JsiiProperty: "delayInput", GoGetter: "DelayInput"},
			_jsii_.MemberProperty{JsiiProperty: "dragDropOptions", GoGetter: "DragDropOptions"},
			_jsii_.MemberProperty{JsiiProperty: "dragDropOptionsInput", GoGetter: "DragDropOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDragDropOptions", GoMethod: "PutDragDropOptions"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCode", GoMethod: "ResetCode"},
			_jsii_.MemberMethod{JsiiMethod: "resetDelay", GoMethod: "ResetDelay"},
			_jsii_.MemberMethod{JsiiMethod: "resetDragDropOptions", GoMethod: "ResetDragDropOptions"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "captureNetworkPayloads", GoGetter: "CaptureNetworkPayloads"},
			_jsii_.MemberProperty{JsiiProperty: "captureNetworkPayloadsInput", GoGetter: "CaptureNetworkPayloadsInput"},
			_jsii_.MemberProperty{JsiiProperty: "checkCertificateRevocation", GoGetter: "CheckCertificateRevocation"},
			_jsii_.MemberProperty{JsiiProperty: "checkCertificateRevocationInput", GoGetter: "CheckCertificateRevocationInput"},
			_jsii_.MemberProperty{JsiiProperty: "ci", GoGetter: "Ci"},
			_jsii_.MemberProperty{JsiiProperty: "ciInput", GoGetter: "CiInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "httpVersion", GoGetter: "HttpVersion"},
			_jsii_.MemberProperty{JsiiProperty: "httpVersionInput", GoGetter: "HttpVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreCertificateValidation", GoGetter: "IgnoreCertificateValidation"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreCertificateValidationInput", GoGetter: "IgnoreCertificateValidationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCaptureNetworkPayloads", GoMethod: "ResetCaptureNetworkPayloads"},
			_jsii_.MemberMethod{JsiiMethod: "resetCheckCertificateRevocation", GoMethod: "ResetCheckCertificateRevocation"},
			_jsii_.MemberMethod{JsiiMethod: "resetCi", GoMethod: "ResetCi"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisableAiaIntermediateFetching", GoMethod: "ResetDisableAiaIntermediateFetching"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFollowRedirects", GoMethod: "ResetFollowRedirects"},
			_jsii_.MemberMethod{JsiiMethod: "resetHttpVersion", GoMethod: "ResetHttpVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreCertificateValidation", GoMethod: "ResetIgnoreCertificateValidation"},
