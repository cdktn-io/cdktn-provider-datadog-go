...
type SyntheticsTestApiStepAssertionOutputReference interface {
	...
	TargetMcpCapabilities() SyntheticsTestApiStepAssertionTargetMcpCapabilitiesOutputReference
	TargetMcpCapabilitiesInput() *SyntheticsTestApiStepAssertionTargetMcpCapabilities
	...
	PutTargetMcpCapabilities(value *SyntheticsTestApiStepAssertionTargetMcpCapabilities)
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) TargetMcpCapabilities() SyntheticsTestApiStepAssertionTargetMcpCapabilitiesOutputReference {
	var returns SyntheticsTestApiStepAssertionTargetMcpCapabilitiesOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) TargetMcpCapabilitiesInput() *SyntheticsTestApiStepAssertionTargetMcpCapabilities {
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsTestApiStepAssertionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsTestApiStepAssertionOutputReference {
	_init_.Initialize()
...
func NewSyntheticsTestApiStepAssertionOutputReference_Override(s SyntheticsTestApiStepAssertionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) PutTargetMcpCapabilities(value *SyntheticsTestApiStepAssertionTargetMcpCapabilities) {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) ResetTargetMcpCapabilities() {
	_jsii_.InvokeVoid(
		s,
		"resetTargetMcpCapabilities",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
